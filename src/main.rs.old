...
extern "C" {
    ...
    fn typeahead(_: libc::c_int) -> libc::c_int;
    ...
    static mut resized_for_browser: sig_atomic_t;
    ...
    static mut foretext: *mut libc::c_char;
    static mut final_status: libc::c_int;
    ...
    static mut cycling_aim: libc::c_int;
    ...
    fn strip_leading_blanks_from(string: *mut libc::c_char);
    ...
    fn rpl_nl_langinfo(item: nl_item) -> *mut libc::c_char;
...
pub const MODERN_BINDINGS: C2RustUnnamed_11 = 50;
pub const ZERO: C2RustUnnamed_11 = 49;
pub const MINIBAR: C2RustUnnamed_11 = 48;
pub const USE_MAGIC: C2RustUnnamed_11 = 47;
pub const STATEFLAGS: C2RustUnnamed_11 = 46;
pub const COLON_PARSING: C2RustUnnamed_11 = 45;
...
pub unsafe extern "C" fn make_new_node(
    ...
    let mut newnode: *mut linestruct = nmalloc(
        ::core::mem::size_of::<linestruct>() as libc::c_ulong,
    ) as *mut linestruct;
    ...
    (*newnode)
        ...
        (*prevnode).lineno + 1 as libc::c_int as ssize_t
    } else {
...
pub unsafe extern "C" fn delete_node(mut line: *mut linestruct) {
    ...
    free((*line).multidata as *mut libc::c_void);
...
pub unsafe extern "C" fn emergency_save(mut filename: *const libc::c_char) {
    ...
    free(targetname as *mut libc::c_void);
    free(plainname as *mut libc::c_void);
}
#[no_mangle]
...
pub unsafe extern "C" fn window_init() {
    ...
    if LINES < 3 as libc::c_int {
        ...
        let mut minimum: libc::c_int = if flags[(ZERO as libc::c_int as libc::c_ulong)
            .wrapping_div(
                (::core::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                    .wrapping_mul(8 as libc::c_int as libc::c_ulong),
            ) as usize]
            ...
            & (1 as libc::c_int as libc::c_uint)
                << (EMPTY_LINE as libc::c_int as libc::c_ulong)
                    .wrapping_rem(
                        (::core::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                            .wrapping_mul(8 as libc::c_int as libc::c_ulong),
                    ) != 0 as libc::c_int as libc::c_uint && LINES > minimum
        {
            2 as libc::c_int
        } else {
            1 as libc::c_int
    ...
    if COLS as ssize_t + fill < 0 as libc::c_int as ssize_t {
        wrap_at = 0 as libc::c_int as size_t;
    } else if fill <= 0 as libc::c_int as ssize_t {
        wrap_at = (COLS as ssize_t + fill) as size_t;
    } else {
...
pub unsafe extern "C" fn usage() {
    ...
    print_opt(
        ...
        b"Syntax definition to use for coloring\0" as *const u8 as *const libc::c_char,
    );
    print_opt(
    ...
    print_opt(
        b"-z\0" as *const u8 as *const libc::c_char,
        b"--listsyntaxes\0" as *const u8 as *const libc::c_char,
        b"List the names of available syntaxes\0" as *const u8 as *const libc::c_char,
    );
    print_opt(
        b"-@\0" as *const u8 as *const libc::c_char,
        b"--colonparsing\0" as *const u8 as *const libc::c_char,
        b"Accept 'filename:linenumber' notation\0" as *const u8 as *const libc::c_char,
    );
    print_opt(
        b"-%\0" as *const u8 as *const libc::c_char,
    ...
    print_opt(
        b"-/\0" as *const u8 as *const libc::c_char,
        b"--modernbindings\0" as *const u8 as *const libc::c_char,
        b"Use better-known key bindings\0" as *const u8 as *const libc::c_char,
    );
}
#[no_mangle]
pub unsafe extern "C" fn version() {
    ...
    printf(
        ...
        b"2025\0" as *const u8 as *const libc::c_char,
    );
    printf(
        dcgettext(
            0 as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn list_syntax_names() {
    let mut width: libc::c_int = 0 as libc::c_int;
    printf(
        dcgettext(
            0 as *const libc::c_char,
            b"Available syntaxes:\n\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    let mut sntx: *mut syntaxtype = syntaxes;
    while !sntx.is_null() {
        if width > 45 as libc::c_int {
            printf(b"\n\0" as *const u8 as *const libc::c_char);
            width = 0 as libc::c_int;
        }
        printf(b" %s\0" as *const u8 as *const libc::c_char, (*sntx).name);
        width = (width as size_t)
            .wrapping_add(
                wideness((*sntx).name, (45 as libc::c_int * 4 as libc::c_int) as size_t),
...
pub unsafe extern "C" fn handle_sigwinch(mut signal: libc::c_int) {
    ...
    ::core::ptr::write_volatile(
        &mut resized_for_browser as *mut sig_atomic_t,
        1 as libc::c_int,
    );
}
#[no_mangle]
pub unsafe extern "C" fn regenerate_screen() {
    ...
    endwin();
    wrefresh(stdscr);
    sidebar = if flags[(INDICATOR as libc::c_int as libc::c_ulong)
        .wrapping_div(
            (::core::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                .wrapping_mul(8 as libc::c_int as libc::c_ulong),
        ) as usize]
    ...
    match flag {
        ...
        2 => {
                        ...
                        ) != 0 as libc::c_int as libc::c_uint
            {
                ...
                toggle_this(ZERO as libc::c_int);
            } else if !(flags[(MINIBAR as libc::c_int as libc::c_ulong)
                .wrapping_div(
                    (::core::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                        .wrapping_mul(8 as libc::c_int as libc::c_ulong),
...
pub unsafe extern "C" fn disable_extended_io() {
    ...
    settings.c_lflag &= !(0o100000 as libc::c_int) as tcflag_t;
    settings.c_oflag &= !(0o1 as libc::c_int) as tcflag_t;
...
pub unsafe extern "C" fn disable_kb_interrupt() {
    ...
    tcgetattr(0 as libc::c_int, &mut settings);
    settings.c_lflag &= !(0o1 as libc::c_int) as tcflag_t;
    tcsetattr(0 as libc::c_int, 0 as libc::c_int, &mut settings);
}
#[no_mangle]
...
pub unsafe extern "C" fn disable_flow_control() {
    ...
    tcgetattr(0 as libc::c_int, &mut settings);
    settings.c_iflag &= !(0o2000 as libc::c_int) as tcflag_t;
    tcsetattr(0 as libc::c_int, 0 as libc::c_int, &mut settings);
}
#[no_mangle]
...
pub unsafe extern "C" fn do_mouse() -> libc::c_int {
    ...
    if wmouse_trafo(midwin, &mut click_row, &mut click_col, 0 as libc::c_int != 0) {
        ...
        let mut row_count: ssize_t = click_row as ssize_t - (*openfile).cursor_row;
        ...
        if row_count < 0 as libc::c_int as ssize_t {
            go_back_chunks(
        ...
        if row_count == 0 as libc::c_int as ssize_t && (*openfile).current_x == was_x {
            do_mark();
            if flags[(STATEFLAGS as libc::c_int as libc::c_ulong)
                .wrapping_div(
                    (::core::mem::size_of::<libc::c_uint>() as libc::c_ulong)
...
pub unsafe extern "C" fn suck_up_input_and_paste_it() {
    ...
    loop {
        ...
        if 0x20 as libc::c_int <= input && input <= 0xff as libc::c_int
            && input != 0x7f as libc::c_int || input == '\t' as i32
        {
            (*line)
                .data = nrealloc(
                (*line).data as *mut libc::c_void,
                index.wrapping_add(2 as libc::c_int as size_t),
            ) as *mut libc::c_char;
            let fresh0 = index;
    ...
    if input != 0x4be as libc::c_int {
        statusline(
            ALERT,
            dcgettext(
                0 as *const libc::c_char,
                b"Flawed paste\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    }
...
pub unsafe extern "C" fn inject(mut burst: *mut libc::c_char, mut count: size_t) {
    ...
    {
        if (*openfile).cursor_row == (editwinrows - 1 as libc::c_int) as ssize_t {
    ...
    (*thisline)
        ...
        datalen.wrapping_add(count).wrapping_add(1 as libc::c_int as size_t),
    ) as *mut libc::c_char;
    memmove(
    ...
    if thisline == (*openfile).mark && (*openfile).current_x < (*openfile).mark_x {
        (*openfile).mark_x = ((*openfile).mark_x).wrapping_add(count);
    }
    (*openfile).current_x = ((*openfile).current_x).wrapping_add(count);
    (*openfile).totsize = ((*openfile).totsize).wrapping_add(mbstrlen(burst));
    set_modified();
                    ...
                    ) != 0 as libc::c_int as libc::c_uint)
    {
        new_magicline();
        if margin != 0
            || !((*openfile).syntax).is_null()
                && (*(*openfile).syntax).multiscore as libc::c_int != 0
        {
            if (*openfile).cursor_row < (editwinrows - 1 as libc::c_int) as ssize_t {
                update_line((*thisline).next, 0 as libc::c_int as size_t);
            }
        }
    }
    update_undo(ADD);
    ...
    if flags[(SOFTWRAP as libc::c_int as libc::c_ulong)
        ...
        && (extra_chunks_in((*openfile).current) != old_amount
            || (*openfile).cursor_row == (editwinrows - 1 as libc::c_int) as ssize_t
                && chunk_for((*openfile).placewewant, (*openfile).current)
                    > original_row)
    {
        refresh_needed = 1 as libc::c_int != 0;
        focusing = 0 as libc::c_int != 0;
...
pub unsafe extern "C" fn process_a_keystroke() {
    ...
    if function.is_none() {
                    ...
                    ) != 0 as libc::c_int as libc::c_uint
        {
            ...
            if depth.wrapping_add(1 as libc::c_int as size_t) == capacity {
                capacity = 2 as libc::c_int as size_t * capacity;
    ...
    if depth > 0 as libc::c_int as size_t
        && (function.is_some() || waiting_keycodes() == 0 as libc::c_int as size_t)
    {
        *puddle.offset(depth as isize) = '\0' as i32 as libc::c_char;
        inject(puddle, depth);
        depth = 0 as libc::c_int as size_t;
    }
    if function != Some(do_cycle as unsafe extern "C" fn() -> ()) {
        cycling_aim = 0 as libc::c_int;
    }
    if function.is_none() {
    ...
    if function != Some(cut_text as unsafe extern "C" fn() -> ())
        && function != Some(copy_text as unsafe extern "C" fn() -> ())
    {
        if function != Some(zap_text as unsafe extern "C" fn() -> ()) {
            keep_cutbuffer = 0 as libc::c_int != 0;
        }
    }
...
unsafe fn main_0(
    ...
    let long_options: [option; 59] = [
        ...
        {
            let mut init = option {
                name: b"listsyntaxes\0" as *const u8 as *const libc::c_char,
                has_arg: 0 as libc::c_int,
                flag: 0 as *mut libc::c_int,
                val: 'z' as i32,
            };
        ...
        {
            let mut init = option {
                name: b"modernbindings\0" as *const u8 as *const libc::c_char,
                has_arg: 0 as libc::c_int,
                flag: 0 as *mut libc::c_int,
                val: '/' as i32,
            };
        ...
        {
            let mut init = option {
                name: b"whitespacedisplay\0" as *const u8 as *const libc::c_char,
                has_arg: 0 as libc::c_int,
                flag: 0 as *mut libc::c_int,
                val: 0xcc as libc::c_int,
            };
            init
        },
        {
            let mut init = option {
                name: b"colonparsing\0" as *const u8 as *const libc::c_char,
                has_arg: 0 as libc::c_int,
                flag: 0 as *mut libc::c_int,
                val: '@' as i32,
            };
    ...
    if !(setlocale(6 as libc::c_int, b"\0" as *const u8 as *const libc::c_char))
        .is_null()
        && strcmp(
            rpl_nl_langinfo(CODESET as libc::c_int),
            b"UTF-8\0" as *const u8 as *const libc::c_char,
        ) == 0 as libc::c_int
    {
        using_utf8 = 1 as libc::c_int != 0;
    }
    bindtextdomain(
    ...
    loop {
        optchr = getopt_long(
            argc,
            argv,
            b"ABC:DEFGHIJ:KLMNOPQ:RST:UVWX:Y:Zabcdef:ghijklmno:pqr:s:tuvwxyz!@%_0/\0"
                as *const u8 as *const libc::c_char,
            long_options.as_ptr(),
            0 as *mut libc::c_int,
        );
        if !(optchr > 0 as libc::c_int) {
            break;
        }
        match optchr {
            65 => {
            ...
            84 => {
                if !parse_num(optarg, &mut tabsize)
                    || tabsize <= 0 as libc::c_int as ssize_t
                {
                    fprintf(
                        stderr,
                        dcgettext(
            ...
            64 => {
                flags[(COLON_PARSING as libc::c_int as libc::c_ulong)
                    .wrapping_div(
                        (::core::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                            .wrapping_mul(8 as libc::c_int as libc::c_ulong),
                    ) as usize]
                    |= (1 as libc::c_int as libc::c_uint)
                        << (COLON_PARSING as libc::c_int as libc::c_ulong)
                            .wrapping_rem(
                                (::core::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                                    .wrapping_mul(8 as libc::c_int as libc::c_ulong),
                            );
            ...
            47 => {
                flags[(MODERN_BINDINGS as libc::c_int as libc::c_ulong)
                    .wrapping_div(
                        (::core::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                            .wrapping_mul(8 as libc::c_int as libc::c_ulong),
                    ) as usize]
                    |= (1 as libc::c_int as libc::c_uint)
                        << (MODERN_BINDINGS as libc::c_int as libc::c_ulong)
                            .wrapping_rem(
                                (::core::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                                    .wrapping_mul(8 as libc::c_int as libc::c_ulong),
                            );
    ...
    if !ignore_rcfiles {
        ...
        if !backup_dir_cmdline.is_null() {
            free(backup_dir as *mut libc::c_void);
            backup_dir = backup_dir_cmdline;
        }
        if !word_chars_cmdline.is_null() {
            free(word_chars as *mut libc::c_void);
            word_chars = word_chars_cmdline;
        }
        if stripeclm_cmdline > 0 as libc::c_int as size_t {
            stripe_column = stripeclm_cmdline as ssize_t;
        }
        if tabsize_cmdline != -(1 as libc::c_int) as ssize_t {
    ...
    if flags[(MODERN_BINDINGS as libc::c_int as libc::c_ulong)
        .wrapping_div(
            (::core::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                .wrapping_mul(8 as libc::c_int as libc::c_ulong),
        ) as usize]
    ...
    quoterc = regcomp(&mut quotereg, quotestr, 1 as libc::c_int);
    if quoterc != 0 as libc::c_int {
        let mut size: size_t = regerror(
            quoterc,
            &mut quotereg,
        ...
        regerror(quoterc, &mut quotereg, message, size);
        die(
            dcgettext(
                0 as *const libc::c_char,
    ...
    foretext = copy_of(b"\0" as *const u8 as *const libc::c_char);
    ...
    if tabsize == -(1 as libc::c_int) as ssize_t {
    ...
    althome = get_keycode(
        b"kHOM3\0" as *const u8 as *const libc::c_char,
        0x425 as libc::c_int,
    );
    altend = get_keycode(
        b"kEND3\0" as *const u8 as *const libc::c_char,
        0x426 as libc::c_int,
    );
    ...
    define_key(b"\x1B[200~\0" as *const u8 as *const libc::c_char, 0x4b5 as libc::c_int);
    define_key(b"\x1B[201~\0" as *const u8 as *const libc::c_char, 0x4be as libc::c_int);
    mousefocusin = get_keycode(
        b"kxIN\0" as *const u8 as *const libc::c_char,
        0x491 as libc::c_int,
    );
    mousefocusout = get_keycode(
        b"kxOUT\0" as *const u8 as *const libc::c_char,
        0x499 as libc::c_int,
    );
    typeahead(-(1 as libc::c_int));
    ...
    while optind < argc && (openfile.is_null() || 1 as libc::c_int != 0) {
                ...
                as libc::c_int == '+' as i32
        {
            ...
            while *(*__ctype_b_loc())
                .offset(
                    *(*argv.offset(optind as isize)).offset(n as isize) as libc::c_uchar
        ...
        ) == 0 as libc::c_int
        {
            ...
            let fresh4 = optind;
            optind = optind + 1;
            let mut filename: *mut libc::c_char = *argv.offset(fresh4 as isize);
            ...
            if flags[(COLON_PARSING as libc::c_int as libc::c_ulong)
                .wrapping_div(
                    (::core::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                        .wrapping_mul(8 as libc::c_int as libc::c_ulong),
                ) as usize]
                & (1 as libc::c_int as libc::c_uint)
                    << (COLON_PARSING as libc::c_int as libc::c_ulong)
                        .wrapping_rem(
                            (::core::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                                .wrapping_mul(8 as libc::c_int as libc::c_ulong),
                        ) != 0 as libc::c_int as libc::c_uint && givenline == 0
                && !(strchr(filename, ':' as i32)).is_null() && givencol == 0
                && stat(filename, &mut fileinfo) < 0 as libc::c_int
            {
                let mut coda: *mut libc::c_char = filename
                    .offset(strlen(filename) as isize);
                loop {
                    loop {
                        coda = coda.offset(-1);
                        if !(coda > filename.offset(1 as libc::c_int as isize)
                            && ('0' as i32 <= *coda as libc::c_int
                                && *coda as libc::c_int <= '9' as i32))
                        {
                            break;
                        }
                    }
                    if !(*coda as libc::c_int == ':' as i32
                        && ('0' as i32
                            <= *coda.offset(1 as libc::c_int as isize) as libc::c_int
                            && *coda.offset(1 as libc::c_int as isize) as libc::c_int
                                <= '9' as i32))
                    {
                        break;
                    }
                    *coda = '\0' as i32 as libc::c_char;
                    if stat(filename, &mut fileinfo) < 0 as libc::c_int {
                        *coda = ':' as i32 as libc::c_char;
                        if !(strchr(coda.offset(1 as libc::c_int as isize), ':' as i32))
                            .is_null()
                        {
                            break;
                        }
                    } else {
                        if !parse_line_column(
                            coda.offset(1 as libc::c_int as isize),
                            &mut givenline,
                            &mut givencol,
                        ) {
                            die(
            ...
            if !open_buffer(filename, 1 as libc::c_int != 0) {
                continue;
            }
        }
        if flags[(POSITIONLOG as libc::c_int as libc::c_ulong)
        ...
        if givenline != 0 as libc::c_int as ssize_t
            || givencol != 0 as libc::c_int as ssize_t
        {
            (*openfile).current = (*openfile).filetop;
            (*openfile).placewewant = 0 as libc::c_int as size_t;
            goto_line_and_column(givenline, givencol, 1 as libc::c_int != 0);
            ...
            free(last_search as *mut libc::c_void);
    ...
    if !startup_problem.is_null() {
        statusline(ALERT, b"%s\0" as *const u8 as *const libc::c_char, startup_problem);
    }
    ...
    loop {
        ...
        if on_a_vt as libc::c_int != 0
            && waiting_keycodes() == 0 as libc::c_int as size_t
        {
        ...
        if (*openfile).current_x == 0 as libc::c_int as size_t
            && *((*(*openfile).current).data).offset(0 as libc::c_int as isize)
                as libc::c_uchar as libc::c_int == 0xef as libc::c_int
            && *((*(*openfile).current).data).offset(1 as libc::c_int as isize)
                as libc::c_uchar as libc::c_int == 0xbb as libc::c_int
            && *((*(*openfile).current).data).offset(2 as libc::c_int as isize)
                as libc::c_uchar as libc::c_int == 0xbf as libc::c_int
            && using_utf8 as libc::c_int != 0
        {
            statusline(
                ...
                dcgettext(
                    0 as *const libc::c_char,
                    b"Byte Order Mark\0" as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
            set_blankdelay_to_one();
