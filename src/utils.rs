...
pub unsafe extern "C" fn get_homedir() {
    if homedir.is_null() {
        ...
        if homenv.is_null() || geteuid() == 0 as libc::c_int as __uid_t {
...
pub unsafe extern "C" fn digits(mut n: ssize_t) -> libc::c_int {
    if n < 100000 as libc::c_int as ssize_t {
        if n < 1000 as libc::c_int as ssize_t {
            if n < 100 as libc::c_int as ssize_t {
                return 2 as libc::c_int
            } else {
                return 3 as libc::c_int
            }
        } else if n < 10000 as libc::c_int as ssize_t {
            return 4 as libc::c_int
        } else {
            return 5 as libc::c_int
        }
    } else if n < 10000000 as libc::c_int as ssize_t {
        if n < 1000000 as libc::c_int as ssize_t {
            return 6 as libc::c_int
        } else {
            return 7 as libc::c_int
        }
    } else if n < 100000000 as libc::c_int as ssize_t {
...
pub unsafe extern "C" fn parse_line_column(
    ...
    comma = strpbrk(string, b",.:\0" as *const u8 as *const libc::c_char);
    if comma.is_null() {
    ...
    *firstpart
        .offset(
            comma.offset_from(string) as libc::c_long as isize,
        ) = '\0' as i32 as libc::c_char;
    retval = parse_num(firstpart, line) as libc::c_int != 0
        && retval as libc::c_int != 0;
    free(firstpart as *mut libc::c_void);
    return retval;
}
#[no_mangle]
...
pub unsafe extern "C" fn free_chararray(
    ...
    while len > 0 as libc::c_int as size_t {
        ...
        free(*array.offset(len as isize) as *mut libc::c_void);
    }
...
pub unsafe extern "C" fn is_separate_word(
    ...
    return (position == 0 as libc::c_int as size_t || !is_alpha_char(before))
...
pub unsafe extern "C" fn strstrwrapper(
                ...
                ) != 0 as libc::c_int as libc::c_uint
    {
                    ...
                    ) != 0 as libc::c_int as libc::c_uint
        {
            ...
            while regmatches[0 as libc::c_int as usize].rm_so as size_t <= ceiling {
                floor = next_rung;
                last_find = regmatches[0 as libc::c_int as usize].rm_so as size_t;
                if last_find == ceiling {
                    break;
        ...
        regmatches[0 as libc::c_int as usize]
            .rm_so = start.offset_from(haystack) as libc::c_long as regoff_t;
...
pub unsafe extern "C" fn nrealloc(
    ...
    section = rpl_realloc(section, howmuch);
    if section.is_null() {
        die(
            dcgettext(
                0 as *const libc::c_char,
...
pub unsafe extern "C" fn measured_copy(
    ...
    let mut thecopy: *mut libc::c_char = nmalloc(
        count.wrapping_add(1 as libc::c_int as size_t),
    ) as *mut libc::c_char;
...
pub unsafe extern "C" fn get_page_start(mut column: size_t) -> size_t {
    if column == 0 as libc::c_int as size_t
        || column.wrapping_add(2 as libc::c_int as size_t) < editwincols as size_t
                    ...
                    ) != 0 as libc::c_int as libc::c_uint
    {
        ...
        return column
            .wrapping_sub(6 as libc::c_int as size_t)
            .wrapping_sub(
                column.wrapping_sub(6 as libc::c_int as size_t)
                    % (editwincols - 8 as libc::c_int) as size_t,
            )
    } else {
        return column.wrapping_sub((editwincols - 2 as libc::c_int) as size_t)
    };
}
#[no_mangle]
...
pub unsafe extern "C" fn wideness(
    ...
    let mut width: size_t = 0 as libc::c_int as size_t;
    if maxlen == 0 as libc::c_int as size_t {
        return 0 as libc::c_int as size_t;
    }
    while *text as libc::c_int != '\0' as i32 {
        ...
        maxlen = maxlen.wrapping_sub(charlen);
        text = text.offset(charlen as isize);
    }
    return width;
}
...
pub unsafe extern "C" fn get_range(
    ...
    if ((*openfile).mark).is_null() {
        ...
        *bot = (*openfile).current;
        ...
        if bot_x == 0 as libc::c_int as size_t && *bot != *top && !also_the_last {
            *bot = (**bot).prev;
        } else {
...
pub unsafe extern "C" fn number_of_characters_in(
    ...
    while line != (*end).next as *const linestruct {
        count = count
            .wrapping_add(
                (mbstrlen((*line).data)).wrapping_add(1 as libc::c_int as size_t),
            );
        line = (*line).next;
    }
    return count.wrapping_sub(1 as libc::c_int as size_t);
}
