...
pub const MODERN_BINDINGS: C2RustUnnamed_10 = 50;
pub const ZERO: C2RustUnnamed_10 = 49;
pub const MINIBAR: C2RustUnnamed_10 = 48;
pub const USE_MAGIC: C2RustUnnamed_10 = 47;
pub const STATEFLAGS: C2RustUnnamed_10 = 46;
pub const COLON_PARSING: C2RustUnnamed_10 = 45;
...
pub unsafe extern "C" fn make_new_buffer() {
    let mut newnode: *mut openfilestruct = nmalloc(
        ::core::mem::size_of::<openfilestruct>() as libc::c_ulong,
    ...
    (*openfile).cursor_row = 0 as libc::c_int as ssize_t;
...
pub unsafe extern "C" fn crop_to_fit(
    ...
    if breadth(name) <= room as size_t {
...
pub unsafe extern "C" fn write_lockfile(
    ...
    *lockdata
    ...
    free(lockdata as *mut libc::c_void);
    if fclose(filestream) == -(1 as libc::c_int)
        || wroteamt < 1024 as libc::c_int as size_t
    {
        statusline(
            MILD,
            dcgettext(
...
pub unsafe extern "C" fn do_lockfile(
    ...
    free(secondcopy as *mut libc::c_void);
    free(namecopy as *mut libc::c_void);
    if !ask_the_user && stat(lockfilename, &mut fileinfo) != -(1 as libc::c_int) {
        ...
        if lockfd < 0 as libc::c_int {
            ...
            free(lockfilename as *mut libc::c_void);
        ...
        close(lockfd);
        if readamt < 68 as libc::c_int as ssize_t
                ...
                != 0x30 as libc::c_int
        {
            ...
            free(lockfilename as *mut libc::c_void);
            free(lockbuf as *mut libc::c_void);
            return 0 as *mut libc::c_char;
        }
        strncpy(
            lockprog.as_mut_ptr(),
        ...
        postedname = crop_to_fit(
            ...
            (COLS as size_t)
                ...
                .wrapping_add(7 as libc::c_int as size_t) as libc::c_int,
        );
        promptstr = nmalloc(
            (strlen(question))
        ...
        free(postedname as *mut libc::c_void);
        free(pidstring as *mut libc::c_void);
        choice = ask_user(0 as libc::c_int != 0, promptstr);
        free(promptstr as *mut libc::c_void);
...
pub unsafe extern "C" fn stat_with_alloc(
    ...
    if (*pstat).is_null() {
        *pstat = nmalloc(::core::mem::size_of::<stat>() as libc::c_ulong) as *mut stat;
    }
    if stat(filename, *pstat) != 0 as libc::c_int {
        free(*pstat as *mut libc::c_void);
        *pstat = 0 as *mut stat;
    }
}
#[no_mangle]
pub unsafe extern "C" fn has_valid_path(mut filename: *const libc::c_char) -> bool {
    ...
    if strcmp(parentdir, b".\0" as *const u8 as *const libc::c_char) == 0 as libc::c_int
    {
        ...
        free(currentdir as *mut libc::c_void);
    }
    if gone {
        statusline(
            ALERT,
    ...
    } else if !(parentinfo.st_mode & 0o170000 as libc::c_int as __mode_t
...
pub unsafe extern "C" fn open_buffer(
    ...
    {
        if fileinfo.st_mode & 0o170000 as libc::c_int as __mode_t
            == 0o40000 as libc::c_int as __mode_t
        {
            statusline(
                ALERT,
            ...
            free(realname as *mut libc::c_void);
            return 0 as libc::c_int != 0;
        }
        if fileinfo.st_mode & 0o170000 as libc::c_int as __mode_t
            == 0o20000 as libc::c_int as __mode_t
            || fileinfo.st_mode & 0o170000 as libc::c_int as __mode_t
        ...
        if new_one as libc::c_int != 0
            && fileinfo.st_mode
                & (0o200 as libc::c_int | 0o200 as libc::c_int >> 3 as libc::c_int
                    | 0o200 as libc::c_int >> 3 as libc::c_int >> 3 as libc::c_int)
                    as __mode_t == 0 && geteuid() == 0 as libc::c_int as __uid_t
        {
            statusline(
                ALERT,
                dcgettext(
...
pub unsafe extern "C" fn redecorate_after_switch() {
    ...
    if !((*openfile).errormessage).is_null() {
        ...
        free((*openfile).errormessage as *mut libc::c_void);
        (*openfile).errormessage = 0 as *mut libc::c_char;
    } else {
...
pub unsafe extern "C" fn close_buffer() {
    ...
    free((*orphan).filename as *mut libc::c_void);
    free_lines((*orphan).filetop);
    free((*orphan).statinfo as *mut libc::c_void);
    free((*orphan).lock_filename as *mut libc::c_void);
    discard_until(0 as *const undostruct);
    free((*orphan).errormessage as *mut libc::c_void);
    openfile = (*orphan).prev;
    if openfile == orphan {
        openfile = 0 as *mut openfilestruct;
    }
    free(orphan as *mut libc::c_void);
...
pub unsafe extern "C" fn read_file(
    ...
    loop {
        ...
        if input as libc::c_int == '\n' as i32 {
            ...
            {
                if num_lines == 0 as libc::c_int as size_t {
                    format = DOS_FILE;
                }
                len = len.wrapping_sub(1);
                len;
            }
        } else if (num_lines == 0 as libc::c_int as size_t
                        ...
                        ) != 0 as libc::c_int as libc::c_uint)
        {
            ...
            *buf.offset(len as isize) = input;
            ...
            len;
            if len == bufsize {
                bufsize = bufsize.wrapping_add(120 as libc::c_int as size_t);
    ...
    if len == 0 as libc::c_int as size_t {
        ...
        if *buf.offset(len.wrapping_sub(1 as libc::c_int as size_t) as isize)
            as libc::c_int == '\r' as i32
            && !(flags[(NO_CONVERT as libc::c_int as libc::c_ulong)
                .wrapping_div(
                    (::core::mem::size_of::<libc::c_uint>() as libc::c_ulong)
    ...
    {
        if format as libc::c_uint == MAC_FILE as libc::c_int as libc::c_uint {
            statusline(
                REMARK,
                dcngettext(
                    0 as *const libc::c_char,
...
pub unsafe extern "C" fn open_file(
    ...
    if fileinfo.st_mode & 0o170000 as libc::c_int as __mode_t
        == 0o10000 as libc::c_int as __mode_t
    {
        statusbar(
            dcgettext(
                0 as *const libc::c_char,
...
pub unsafe extern "C" fn get_next_filename(
    ...
    buf = nmalloc(wholenamelen.wrapping_add(7 as libc::c_int as size_t))
        as *mut libc::c_char;
...
pub unsafe extern "C" fn insert_a_file_or(mut execute: bool) {
    ...
    if execute as libc::c_int != 0 && *foretext as libc::c_int != 0 {
...
pub unsafe extern "C" fn get_full_path(
    ...
    free(untilded as *mut libc::c_void);
    return target;
}
#[no_mangle]
...
pub unsafe extern "C" fn safe_tempfile(mut stream: *mut *mut FILE) -> *mut libc::c_char {
    ...
    *stream = if descriptor > 0 as libc::c_int {
    ...
    if (*stream).is_null() {
        ...
        free(tempfile_name as *mut libc::c_void);
        return 0 as *mut libc::c_char;
    }
...
pub unsafe extern "C" fn copy_file(
    ...
    loop {
        ...
        if charsread == 0 as libc::c_int as size_t && ferror(inn) != 0 {
        ...
        ) < charsread
        {
            ...
            break;
        } else if !(charsread > 0 as libc::c_int as size_t) {
            break;
        }
    }
    ...
    if flush_out_fnc.expect("non-null function pointer")(out) == -(1 as libc::c_int) {
...
pub unsafe extern "C" fn make_backup_of(mut realname: *mut libc::c_char) -> bool {
    ...
    {
        current_block = 6141319026862438652;
    } else {
        ...
        current_block = 16394237800570971554;
    }
    loop {
        match current_block {
            6141319026862438652 => {
        ...
        && outside_of_confinement(realname, 0 as libc::c_int != 0) as libc::c_int != 0
    {
                ...
                || !((*openfile).mark).is_null())
        {
            if !make_backup_of(realname) {
                current_block = 15967692879290108994;
            } else {
                                        ...
                                        match current_block {
                                            ...
                                            _ => {
                                                ...
                                                match current_block {
                                                    ...
                                                    _ => {
                                                        if method as libc::c_uint
                                                            == EMERGENCY as libc::c_int as libc::c_uint
                                                            && descriptor != 0 && !((*openfile).statinfo).is_null()
                                                        {
                                                            fchmod(descriptor, (*(*openfile).statinfo).st_mode) != 0;
                                                            fchown(
                                                                descriptor,
                                                                (*(*openfile).statinfo).st_uid,
                                                                (*(*openfile).statinfo).st_gid,
                                                                    ...
                                                                    == OVERWRITE as libc::c_int as libc::c_uint
                                                            {
                                                                    ...
                                                                    != 0 as libc::c_int
                                                                {
                                                                    if !((*openfile).lock_filename).is_null() {
                                                                        ...
                                                                        free((*openfile).lock_filename as *mut libc::c_void);
                                                                    }
                                                                    if flags[(LOCKING as libc::c_int as libc::c_ulong)
                                                                        .wrapping_div(
                                                                            (::core::mem::size_of::<libc::c_uint>() as libc::c_ulong)
...
pub unsafe extern "C" fn write_region_to_file(
    ...
    if normal as libc::c_int != 0 && bot_x > 0 as libc::c_int as size_t
    ...
    loop {
                        ...
                        ) != 0 as libc::c_int as libc::c_uint)
        {
            ...
            msg = if method as libc::c_uint == PREPEND as libc::c_int as libc::c_uint {
                dcgettext(
                    0 as *const libc::c_char,
                    b"Prepend to File\0" as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                )
            } else {
                dcgettext(
                    0 as *const libc::c_char,
                    b"Append to File\0" as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                )
            };
        } else {
            msg = dcgettext(
                0 as *const libc::c_char,
                b"Write to File\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            );
        }
        present_path = mallocstrcpy(
        ...
        if method as libc::c_uint == OVERWRITE as libc::c_int as libc::c_uint {
            ...
            free(full_filename as *mut libc::c_void);
            free(full_answer as *mut libc::c_void);
            if do_warning {
...
pub unsafe extern "C" fn real_dir_from_tilde(
    ...
    free(tilded as *mut libc::c_void);
    return retval;
}
#[no_mangle]
...
pub unsafe extern "C" fn is_dir(mut path: *const libc::c_char) -> bool {
    ...
    retval = stat(thepath, &mut fileinfo) != -(1 as libc::c_int)
        && fileinfo.st_mode & 0o170000 as libc::c_int as __mode_t
            == 0o40000 as libc::c_int as __mode_t;
    free(thepath as *mut libc::c_void);
    return retval;
}
#[no_mangle]
pub unsafe extern "C" fn username_completion(
    ...
    loop {
        ...
        if !(strncmp(
            ...
            length.wrapping_sub(1 as libc::c_int as size_t),
        ) == 0 as libc::c_int)
        {
            continue;
        }
...
pub unsafe extern "C" fn filename_completion(
    ...
    if !slash.is_null() {
        ...
        *slash = '\0' as i32 as libc::c_char;
        ...
        free(wasdirname as *mut libc::c_void);
    } else {
        filename = dirname_0;
    ...
    if dir.is_null() {
        ...
        free(dirname_0 as *mut libc::c_void);
...
pub unsafe extern "C" fn input_tab(
    ...
    if *listed as libc::c_int != 0 && num_matches < 2 as libc::c_int as size_t {
        refresh_func.expect("non-null function pointer")();
    ...
    loop {
        ...
        common_len = common_len.wrapping_add(len1 as size_t);
    }
    shared = nmalloc(
        length_of_path.wrapping_add(common_len).wrapping_add(1 as libc::c_int as size_t),
    ) as *mut libc::c_char;
    ...
    common_len = common_len.wrapping_add(length_of_path);
    *shared.offset(common_len as isize) = '\0' as i32 as libc::c_char;
    ...
    if num_matches == 1 as libc::c_int as size_t
    ...
    if common_len != *place {
        morsel = nrealloc(
            ...
            common_len.wrapping_add(1 as libc::c_int as size_t),
        ) as *mut libc::c_char;
        strncpy(morsel, shared, common_len);
        *morsel.offset(common_len as isize) = '\0' as i32 as libc::c_char;
        *place = common_len;
    } else if num_matches == 1 as libc::c_int as size_t {
        beep();
    }
    if num_matches > 1 as libc::c_int as size_t {
        ...
        if longest_name > (COLS - 1 as libc::c_int) as size_t {
            longest_name = (COLS - 1 as libc::c_int) as size_t;
        }
        ncols = (COLS + 1 as libc::c_int) as size_t
            / longest_name.wrapping_add(2 as libc::c_int as size_t);
        nrows = num_matches.wrapping_add(ncols).wrapping_sub(1 as libc::c_int as size_t)
            / ncols;
        row = (if nrows < lastrow as size_t {
            (lastrow as size_t).wrapping_sub(nrows)
        } else {
            0 as libc::c_int as size_t
        }) as libc::c_int;
        blank_edit();
        ...
        while match_0 < num_matches {
            ...
            wmove(
                ...
                row,
                (longest_name.wrapping_add(2 as libc::c_int as size_t)
                    * (match_0 % ncols)) as libc::c_int,
            );
            if row == lastrow
                && match_0.wrapping_add(1 as libc::c_int as size_t) % ncols
                    == 0 as libc::c_int as size_t
                && match_0.wrapping_add(1 as libc::c_int as size_t) < num_matches
            {
                waddnstr(
                    midwin,
                    dcgettext(
                ...
                free(disp as *mut libc::c_void);
                if match_0.wrapping_add(1 as libc::c_int as size_t) % ncols
                    == 0 as libc::c_int as size_t
                {
                    row += 1;
                    row;
    ...
    free(glued as *mut libc::c_void);
    free(shared as *mut libc::c_void);
    return morsel;
}
