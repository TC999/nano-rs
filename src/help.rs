...
pub unsafe extern "C" fn help_init() {
    ...
    } else if currmenu == (1 as libc::c_int) << 3 as libc::c_int {
        htx[0 as libc::c_int
            as usize] = b"=== Replacement ===\n\n Type the characters that should replace what you typed at the previous prompt, and press Enter.\n\n\0"
            as *const u8 as *const libc::c_char;
        htx[1 as libc::c_int
            as usize] = b" The following function keys are available at this prompt:\n\n\0"
            as *const u8 as *const libc::c_char;
        htx[2 as libc::c_int as usize] = 0 as *const libc::c_char;
    ...
    help_text = nmalloc(allocsize.wrapping_add(1 as libc::c_int as size_t))
        as *mut libc::c_char;
...
pub unsafe extern "C" fn show_help() {
    ...
    loop {
        ...
        {
            if ((*(*openfile).edittop).lineno + editwinrows as ssize_t
                - 1 as libc::c_int as ssize_t) < (*(*openfile).filebot).lineno
            {
                do_scroll_down();
            }
        ...
        {
            function.expect("non-null function pointer")();
        } else if function == Some(do_search_backward as unsafe extern "C" fn() -> ())
            ...
            >(Some(implant as unsafe extern "C" fn(*const libc::c_char) -> ()))
        {
            ...
            while get_kbinput(midwin, 0 as libc::c_int != 0) != 0x4be as libc::c_int {}
            statusline(
                AHEM,
                dcgettext(
                    0 as *const libc::c_char,
    ...
    answer = saved_answer;
    free(help_text as *mut libc::c_void);
