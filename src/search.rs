...
pub unsafe extern "C" fn regexp_init(mut regexp: *const libc::c_char) -> bool {
    let mut value: libc::c_int = regcomp(
        &mut search_regexp,
        regexp,
        1 as libc::c_int
    ...
    if value != 0 as libc::c_int {
        ...
        regerror(value, &mut search_regexp, str, len);
        statusline(
            AHEM,
            dcgettext(
...
pub unsafe extern "C" fn findnextstr(
    ...
    loop {
        ...
        if time(0 as *mut time_t) - lastkbcheck > 0 as libc::c_int as time_t {
...
pub unsafe extern "C" fn replace_regexp(
    ...
    while *c as libc::c_int != '\0' as i32 {
        ...
        if *c as libc::c_int != '\\' as i32 || num < 1 as libc::c_int
            || num > 9 as libc::c_int || num as size_t > search_regexp.re_nsub
        {
            if create {
                let fresh0 = string;
            ...
            replacement_size = replacement_size.wrapping_add(i);
            if create {
                strncpy(
                    string,
...
pub unsafe extern "C" fn replace_line(
                ...
                ) != 0 as libc::c_int as libc::c_uint
    {
        ...
        new_size = new_size
            .wrapping_add(
                (replace_regexp(0 as *mut libc::c_char, 0 as libc::c_int != 0) as size_t)
...
pub unsafe extern "C" fn do_replace_loop(
    ...
    loop {
        ...
        if result < 1 as libc::c_int {
            ...
            if numreplaced == -(1 as libc::c_int) as ssize_t {
            ...
            if choice == 1 as libc::c_int || replaceall as libc::c_int != 0 {
                ...
                if !was_mark.is_null() && !right_side_up {
                        ...
                        && (*openfile).mark_x > (*openfile).current_x
                    {
                            ...
                            < ((*openfile).current_x).wrapping_add(match_len)
                        {
                            ...
                            (*openfile)
                                .mark_x = ((*openfile).mark_x).wrapping_add(length_change);
                        }
                ...
                if was_mark.is_null() || right_side_up as libc::c_int != 0 {
                        ...
                        && (*openfile).current_x < *real_current_x
                    {
                        ...
                        *real_current_x = (*real_current_x).wrapping_add(length_change);
                        bot_x = *real_current_x;
                    }
                }
                if match_len == 0 as libc::c_int as size_t
                            ...
                            ) != 0 as libc::c_int as libc::c_uint)
                {
                    (*openfile)
                        ...
                        .wrapping_add(match_len.wrapping_add(length_change));
                }
                (*openfile)
                ...
                free((*(*openfile).current).data as *mut libc::c_void);
...
pub unsafe extern "C" fn ask_for_and_do_replacements() {
    ...
    let mut replacee: *mut libc::c_char = copy_of(last_search);
    ...
    refresh_needed = 1 as libc::c_int != 0;
    if numreplaced >= 0 as libc::c_int as ssize_t {
        statusline(
            REMARK,
            dcngettext(
                0 as *const libc::c_char,
...
pub unsafe extern "C" fn goto_line_posx(mut linenumber: ssize_t, mut pos_x: size_t) {
    if linenumber > (*(*openfile).edittop).lineno + editwinrows as ssize_t
...
#[no_mangle]
pub unsafe extern "C" fn ask_for_line_and_column(mut provided: *mut libc::c_char) {
    let mut line: ssize_t = (*(*openfile).current).lineno;
    let mut column: ssize_t = ((*openfile).placewewant)
        .wrapping_add(1 as libc::c_int as size_t) as ssize_t;
    let mut response: libc::c_int = do_prompt(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"Enter line number, column number\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    let mut doublesign: libc::c_int = 0 as libc::c_int;
    ...
    if *answer.offset(0 as libc::c_int as isize) as libc::c_int == '+' as i32
        && *answer.offset(1 as libc::c_int as isize) as libc::c_int == '+' as i32
        || *answer.offset(0 as libc::c_int as isize) as libc::c_int == '-' as i32
            && *answer.offset(1 as libc::c_int as isize) as libc::c_int == '-' as i32
    {
        doublesign = 1 as libc::c_int;
    }
    if !parse_line_column(answer.offset(doublesign as isize), &mut line, &mut column) {
        statusline(
            AHEM,
            dcgettext(
                0 as *const libc::c_char,
                b"Invalid line or column number\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        return;
    ...
    goto_line_and_column(line, column, 0 as libc::c_int != 0);
    adjust_viewport(
...
pub unsafe extern "C" fn goto_line_and_column(
    ...
    if line < 0 as libc::c_int as ssize_t {
        line = (*(*openfile).filebot).lineno + line + 1 as libc::c_int as ssize_t;
    } else if line == 0 as libc::c_int as ssize_t {
        line = (*(*openfile).current).lineno;
    }
    if line < 1 as libc::c_int as ssize_t {
        line = 1 as libc::c_int as ssize_t;
    }
    if line > (*(*openfile).edittop).lineno + editwinrows as ssize_t
        || flags[(SOFTWRAP as libc::c_int as libc::c_ulong)
            .wrapping_div(
                (::core::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                    .wrapping_mul(8 as libc::c_int as libc::c_ulong),
    ...
    if column < 0 as libc::c_int as ssize_t {
        column = (breadth((*(*openfile).current).data))
            .wrapping_add(column as size_t)
            .wrapping_add(2 as libc::c_int as size_t) as ssize_t;
    } else if column == 0 as libc::c_int as ssize_t {
        column = ((*openfile).placewewant).wrapping_add(1 as libc::c_int as size_t)
            as ssize_t;
    }
    if column < 1 as libc::c_int as ssize_t {
        column = 1 as libc::c_int as ssize_t;
    }
    (*openfile)
        .current_x = actual_x(
        (*(*openfile).current).data,
        (column - 1 as libc::c_int as ssize_t) as size_t,
    );
    (*openfile).placewewant = (column - 1 as libc::c_int as ssize_t) as size_t;
    if flags[(SOFTWRAP as libc::c_int as libc::c_ulong)
        ...
        && (*openfile).placewewant / editwincols as size_t
            > breadth((*(*openfile).current).data) / editwincols as size_t
    {
    ...
    {
        (*openfile)
            .cursor_row = (editwinrows - 1 as libc::c_int - rows_from_tail) as ssize_t;
...
pub unsafe extern "C" fn do_find_bracket() {
    ...
    let mut charcount: size_t = mbstrlen(matchbrackets) / 2 as libc::c_int as size_t;
    ...
    while i < charcount {
        halfway = halfway
            .wrapping_add(char_length(matchbrackets.offset(halfway as isize)) as size_t);
        i = i.wrapping_add(1);
        i;
    }
    ...
    while find_a_bracket(reverse, bracket_pair.as_mut_ptr()) {
        ...
        if balance == 0 as libc::c_int as size_t {
...
pub unsafe extern "C" fn go_to_and_confirm(mut line: *mut linestruct) {
    ...
    if line != (*openfile).current {
        ...
        if (*line).lineno > (*(*openfile).edittop).lineno + editwinrows as ssize_t
            || flags[(SOFTWRAP as libc::c_int as libc::c_ulong)
                .wrapping_div(
                    (::core::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                        .wrapping_mul(8 as libc::c_int as libc::c_ulong),
