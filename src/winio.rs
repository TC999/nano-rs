...
extern "C" {
    ...
    static mut althome: libc::c_int;
    static mut altend: libc::c_int;
    ...
    static mut mousefocusin: libc::c_int;
    static mut mousefocusout: libc::c_int;
...
pub const MODERN_BINDINGS: C2RustUnnamed_1 = 50;
pub const ZERO: C2RustUnnamed_1 = 49;
pub const MINIBAR: C2RustUnnamed_1 = 48;
pub const USE_MAGIC: C2RustUnnamed_1 = 47;
pub const STATEFLAGS: C2RustUnnamed_1 = 46;
pub const COLON_PARSING: C2RustUnnamed_1 = 45;
...
static mut countdown: libc::c_int = 0 as libc::c_int;
...
static mut milestone: size_t = 0 as libc::c_int as size_t;
#[no_mangle]
pub unsafe extern "C" fn add_to_macrobuffer(mut code: libc::c_int) {
    ...
    macro_buffer = nrealloc(
        ...
        macro_length.wrapping_mul(::core::mem::size_of::<libc::c_int>() as libc::c_ulong),
    ) as *mut libc::c_int;
    *macro_buffer
        .offset(macro_length.wrapping_sub(1 as libc::c_int as size_t) as isize) = code;
}
#[no_mangle]
...
pub unsafe extern "C" fn run_macro() {
    ...
    if macro_length == 0 as libc::c_int as size_t {
        statusline(
            AHEM,
            dcgettext(
                0 as *const libc::c_char,
    ...
    let mut index: size_t = macro_length;
    while index > 0 as libc::c_int as size_t {
        index = index.wrapping_sub(1);
        put_back(*macro_buffer.offset(index as isize));
    }
    ...
    while input == -(1 as libc::c_int) {
        ...
        if input == -(1 as libc::c_int)
            && {
                ...
                errcount == 12345678 as libc::c_int as size_t
            }
        {
            die(
                dcgettext(
    ...
    *key_buffer.offset(0 as libc::c_int as isize) = input;
    ...
    loop {
        ...
        if waiting_codes == capacity {
            reserve_space_for(2 as libc::c_int as size_t * capacity);
        }
...
pub unsafe extern "C" fn get_code_from_plantation() -> libc::c_int {
    if *plants_pointer as libc::c_int == '{' as i32 {
        ...
        if *plants_pointer.offset(1 as libc::c_int as isize) as libc::c_int == '{' as i32
            || *plants_pointer.offset(1 as libc::c_int as isize) as libc::c_int
                == '}' as i32
        {
            if *plants_pointer.offset(2 as libc::c_int as isize) as libc::c_int
                != '}' as i32
            {
                return 0x4eb as libc::c_int;
            }
            ...
            return *plants_pointer.offset(-(2 as libc::c_int as isize)) as libc::c_int;
        }
        free(commandname as *mut libc::c_void);
        free(planted_shortcut as *mut libc::c_void);
        ...
        let mut firstbyte: libc::c_uchar = *plants_pointer as libc::c_uchar;
        ...
        return if firstbyte as libc::c_int != 0 {
            firstbyte as libc::c_int
        } else {
            -(1 as libc::c_int)
        };
    };
...
pub unsafe extern "C" fn convert_SS3_sequence(
    ...
    match *seq.offset(0 as libc::c_int as isize) {
        ...
        50 => {
            current_block_48 = 9136417929743427374;
        }
        51 => {
            current_block_48 = 9136417929743427374;
        }
        52 => {
            current_block_48 = 2719099962069521503;
        }
        53 => {
            current_block_48 = 9509293030025339089;
        }
        54 => {
            current_block_48 = 168341659703913706;
        }
        55 | 56 => {
            current_block_48 = 9947228741818598937;
        }
        65 => {
            current_block_48 = 11490014007502242199;
        }
        66 => {
            current_block_48 = 11490014007502242199;
        }
        67 | 68 => {
            current_block_48 = 213109806634550190;
        }
        70 => return 0o550 as libc::c_int,
        72 => return 0o406 as libc::c_int,
        77 => return 0o527 as libc::c_int,
        80 => {
            current_block_48 = 10124870764038846677;
        }
        81 => {
            current_block_48 = 10124870764038846677;
        }
        82 | 83 => {
            current_block_48 = 15901354531945237593;
        }
        84 => {
            current_block_48 = 18306521987677585429;
        }
        85 => {
            current_block_48 = 18306521987677585429;
        }
        86 => {
            current_block_48 = 6382576208935924907;
        }
        87 => {
            current_block_48 = 12308233504405787626;
        }
        88 | 89 => {
            current_block_48 = 4104604451741475173;
        }
    ...
    match current_block_48 {
        ...
        11490014007502242199 => {
            current_block_48 = 213109806634550190;
        }
        10124870764038846677 => {
            current_block_48 = 15901354531945237593;
        }
    ...
    match current_block_48 {
        9947228741818598937 => {
            if length > 1 as libc::c_int as size_t {
    ...
    's_708: {
        ...
        match *seq.offset(0 as libc::c_int as isize) {
            49 => {
                ...
                } else if length > 2 as libc::c_int as size_t
                    && *seq.offset(2 as libc::c_int as isize) == '~' as i32
                {
                    *consumed = 3 as libc::c_int;
                    's_42: {
                        ...
                        match *seq.offset(1 as libc::c_int as isize) {
                            50 => {
                                current_block_5 = 17213680416547596695;
                            }
                            51 => {
                                current_block_5 = 17213680416547596695;
                            }
                            52 => {
                                current_block_5 = 9266748858064545811;
                            }
                            49 | 53 => {
                                current_block_5 = 4431214692794743262;
                            }
                            56 => {
                                current_block_5 = 6111489894570701767;
                            }
                            55 | 57 => {
                                current_block_5 = 6111489894570701767;
                            }
                ...
                } else if length > 3 as libc::c_int as size_t
                    && *seq.offset(1 as libc::c_int as isize) == ';' as i32
                {
                    *consumed = 4 as libc::c_int;
                    match *seq.offset(2 as libc::c_int as isize) {
                        50 => 's_83: {
                            ...
                            match *seq.offset(3 as libc::c_int as isize) {
                                66 => {
                                    current_block_12 = 8160275820283752248;
                                }
                                67 => {
                                    current_block_12 = 8160275820283752248;
                                }
                                65 | 68 => {
                                    current_block_12 = 12165223622796441914;
                                }
                        ...
                        57 | 51 => {
                            match *seq.offset(3 as libc::c_int as isize) {
                                ...
                                70 => return 0x426 as libc::c_int,
                                72 => return 0x425 as libc::c_int,
                                _ => {}
                            }
                        }
                        52 => {
                ...
                current_block_154 = 5089124893069931607;
            }
            50 => {
                if length > 2 as libc::c_int as size_t
                    && *seq.offset(2 as libc::c_int as isize) == '~' as i32
                {
                    *consumed = 3 as libc::c_int;
                    match *seq.offset(1 as libc::c_int as isize) {
                        ...
                        53 => return 0o410 as libc::c_int + 13 as libc::c_int,
                        54 => return 0o410 as libc::c_int + 14 as libc::c_int,
                        56 => return 0o410 as libc::c_int + 15 as libc::c_int,
                        57 => return 0o410 as libc::c_int + 16 as libc::c_int,
                        _ => {}
                    }
                } else if length > 1 as libc::c_int as size_t
                    && *seq.offset(1 as libc::c_int as isize) == '~' as i32
                {
                ...
                {
                    *consumed = 4 as libc::c_int;
                    return if *seq.offset(2 as libc::c_int as isize) == '0' as i32 {
                        0x4b5 as libc::c_int
                    } else {
                        0x4be as libc::c_int
                    };
                } else {
                    *consumed = length as libc::c_int;
                    return 0x4fc as libc::c_int;
                }
                current_block_154 = 5089124893069931607;
            }
            ...
            65 => {
                current_block_154 = 11837235381941550773;
            }
            66 => {
                current_block_154 = 11837235381941550773;
            }
            67 | 68 => {
                current_block_154 = 4961014539618715094;
            }
            70 => return 0o550 as libc::c_int,
            ...
            77 => {
                current_block_154 = 10004584080147241958;
            }
            78 => {
                current_block_154 = 10004584080147241958;
            }
            79 => {
                current_block_154 = 3706286293194913834;
            }
            80 => {
                current_block_154 = 4380541304866276873;
            }
            81 => {
                current_block_154 = 15531741053463456202;
            }
            82 => {
                current_block_154 = 12585425325671093681;
            }
            83 | 84 => {
                current_block_154 = 10674721651485512707;
            }
            ...
            97 => {
                current_block_154 = 9150584233239898461;
            }
            98 => {
                current_block_154 = 9150584233239898461;
            }
            99 | 100 => {
                current_block_154 = 14534214718151125713;
            }
            91 => {
                if length > 1 as libc::c_int as size_t {
                    *consumed = 2 as libc::c_int;
        ...
        match current_block_154 {
            11837235381941550773 => {
                current_block_154 = 4961014539618715094;
            }
            10004584080147241958 => {
                current_block_154 = 3706286293194913834;
            }
            9150584233239898461 => {
                current_block_154 = 14534214718151125713;
...
pub unsafe extern "C" fn parse_escape_sequence(mut starter: libc::c_int) -> libc::c_int {
    ...
    waiting_codes = waiting_codes.wrapping_sub(consumed as size_t);
...
pub unsafe extern "C" fn parse_kbinput(mut frame: *mut WINDOW) -> libc::c_int {
    ...
    if keycode == 0x1b as libc::c_int {
        ...
        last_escape_was_alone = waiting_codes == 0 as libc::c_int as size_t;
    ...
    if escapes == 0 as libc::c_int {
        ...
        } else if waiting_codes == 0 as libc::c_int as size_t
            || *nextcodes.offset(0 as libc::c_int as isize) == 0x1b as libc::c_int
            || keycode != 'O' as i32 && keycode != '[' as i32
        {
            if 'A' as i32 <= keycode && keycode <= 'Z' as i32 && !shifted_metas {
                keycode |= 0x20 as libc::c_int;
            }
            meta_key = 1 as libc::c_int != 0;
        } else {
    ...
    if keycode == controlleft {
        ...
        return 0x425 as libc::c_int
    } else if keycode == altend {
        return 0x426 as libc::c_int
        ...
        ) >= 0 as libc::c_int
    {
        ...
        if modifiers as libc::c_int == 0x8 as libc::c_int {
            match keycode {
                ...
                262 => return 0x425 as libc::c_int,
                360 => return 0x426 as libc::c_int,
    ...
    's_975: {
        ...
        match keycode {
            ...
            391 | 1109 => {
                shift_held = 1 as libc::c_int != 0;
                current_block_240 = 13874584177866077742;
            }
            348 => {
                current_block_240 = 13874584177866077742;
            }
            386 | 1110 => {
                shift_held = 1 as libc::c_int != 0;
                current_block_240 = 16724872455702241989;
            }
            351 => {
                current_block_240 = 16724872455702241989;
            }
            ...
            398 | 1111 => {
                shift_held = 1 as libc::c_int != 0;
                current_block_240 = 11446132837607328968;
            }
            349 => {
                current_block_240 = 11446132837607328968;
            }
            396 | 1112 => {
                shift_held = 1 as libc::c_int != 0;
                current_block_240 = 5359315320307322254;
            }
            352 => {
                current_block_240 = 5359315320307322254;
            }
        ...
        match current_block_240 {
            5359315320307322254 => return 0o522 as libc::c_int,
            16724872455702241989 => return 0o550 as libc::c_int,
            11446132837607328968 => return 0o523 as libc::c_int,
...
pub unsafe extern "C" fn assemble_unicode(mut symbol: libc::c_int) -> libc::c_long {
    ...
    {
        let mut partial: [libc::c_char; 7] = *::core::mem::transmute::<
            &[u8; 7],
            &mut [libc::c_char; 7],
        >(b"      \0");
        sprintf(
...
pub unsafe extern "C" fn parse_verbatim_kbinput(
    ...
    keycode = get_input(frame);
    if keycode == 0x4f7 as libc::c_int {
            ...
            & _ISxdigit as libc::c_int as libc::c_ushort as libc::c_int != 0
    {
        ...
        if keycode == 0x4f7 as libc::c_int {
            *count = 999 as libc::c_int as size_t;
            free(yield_0 as *mut libc::c_void);
            return 0 as *mut libc::c_int;
        }
        ...
        *count = wctomb(multibyte.as_mut_ptr(), unicode as wchar_t) as size_t;
        if *count > 4 as libc::c_int as size_t {
...
pub unsafe extern "C" fn get_verbatim_kbinput(
    ...
    if !input.is_null() && *count != 0 {
        if *input >= 0x80 as libc::c_int && *count == 1 as libc::c_int as size_t {
            put_back(*input);
            *count = 999 as libc::c_int as size_t;
    ...
    if *count < 999 as libc::c_int as size_t {
        let mut i: size_t = 0 as libc::c_int as size_t;
        while i < *count {
...
pub unsafe extern "C" fn get_mouseinput(
    ...
    *mouse_y = event.y;
    if event.bstate as libc::c_ulong
        & ((0o1 as libc::c_ulong)
                ...
                << (1 as libc::c_int - 1 as libc::c_int) * 5 as libc::c_int) != 0
    {
            ...
            && in_footer as libc::c_int != 0
        {
            ...
            if number < 5 as libc::c_int as size_t {
                width = COLS / 2 as libc::c_int;
            } else {
                width = (COLS as size_t
                    / (number.wrapping_add(1 as libc::c_int as size_t)
                        / 2 as libc::c_int as size_t)) as libc::c_int;
            }
            index = *mouse_x / width * 2 as libc::c_int + *mouse_y;
            if index as size_t > number && *mouse_x % width < COLS % width {
                index -= 2 as libc::c_int;
            }
            if index as size_t > number {
    ...
    } else if event.bstate as libc::c_ulong
        & ((0o2 as libc::c_ulong)
                ...
                << (5 as libc::c_int - 1 as libc::c_int) * 5 as libc::c_int) != 0
    {
        ...
        {
            let mut keycode: libc::c_int = if event.bstate as libc::c_ulong
                & (0o2 as libc::c_ulong)
...
#[no_mangle]
pub unsafe extern "C" fn blank_it_when_expired() {
    if countdown == 0 as libc::c_int {
        return;
    }
    countdown -= 1;
    if countdown == 0 as libc::c_int {
...
pub unsafe extern "C" fn display_string(
    ...
    let mut allocsize: size_t = ((COLS as size_t).wrapping_add(stowaways)
    ...
    if (start_col < column
        || start_col > 0 as libc::c_int as size_t && isdata as libc::c_int != 0
            ...
            && *text as libc::c_int != 0x7f as libc::c_int || 0 as libc::c_int != 0
        {
            ...
            *converted.offset(fresh6 as isize) = *fresh5;
            ...
            if flags[(WHITESPACE_DISPLAY as libc::c_int as libc::c_ulong)
                ...
                && (index > 0 as libc::c_int as size_t || !isdata
                    || !(flags[(SOFTWRAP as libc::c_int as libc::c_ulong)
                        .wrapping_div(
                            (::core::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                                .wrapping_mul(8 as libc::c_int as libc::c_ulong),
                    ...
                    || column % tabsize as size_t == 0 as libc::c_int as size_t
                    || column == start_col)
            {
            ...
            column = column.wrapping_add(1);
            column;
            while column % tabsize as size_t != 0 as libc::c_int as size_t
                && column < beyond
            {
                let fresh13 = index;
                index = index.wrapping_add(1);
            ...
            *converted.offset(fresh15 as isize) = control_mbrep(text, isdata);
            text = text.offset(char_length(text) as isize);
            column = column.wrapping_add(2 as libc::c_int as size_t);
        } else {
                ...
                *converted.offset(fresh18 as isize) = -67i32 as libc::c_char;
                ...
                if charwidth == 0 as libc::c_int
                    && {
                        ...
                        stowaways == 0 as libc::c_int as size_t
                    }
                {
                    stowaways = 40 as libc::c_int as size_t;
                    allocsize = allocsize
                        .wrapping_add(stowaways * 4 as libc::c_int as size_t);
...
pub unsafe extern "C" fn titlebar(mut path: *const libc::c_char) {
    ...
    if currmenu == (1 as libc::c_int) << 14 as libc::c_int {
        ...
        if more_than_one {
            ...
            upperleft = b"GNU nano 8.6\0" as *const u8 as *const libc::c_char;
        }
    ...
    verlen = (breadth(upperleft)).wrapping_add(3 as libc::c_int as size_t);
    prefixlen = breadth(prefix);
    if prefixlen > 0 as libc::c_int as size_t {
        prefixlen = prefixlen.wrapping_add(1);
        prefixlen;
    }
    pathlen = breadth(path);
    statelen = (breadth(state)).wrapping_add(2 as libc::c_int as size_t);
    if statelen > 2 as libc::c_int as size_t {
    ...
    if verlen
        ...
        .wrapping_add(statelen) <= COLS as size_t
    {
            ...
            .wrapping_add(statelen) > COLS as size_t
        {
            ...
            statelen = statelen.wrapping_sub(2 as libc::c_int as size_t);
        }
    }
    free(ranking as *mut libc::c_void);
    if verlen > 0 as libc::c_int as size_t {
        offset = verlen
            .wrapping_add(
                (COLS as size_t)
    ...
    if pathlen.wrapping_add(pluglen).wrapping_add(statelen) <= COLS as size_t {
    ...
    } else if (5 as libc::c_int as size_t).wrapping_add(statelen) <= COLS as size_t {
        waddnstr(
            topwin,
            b"...\0" as *const u8 as *const libc::c_char,
            -(1 as libc::c_int),
        ...
        caption = display_string(
            ...
            (3 as libc::c_int as size_t)
                .wrapping_add(pathlen)
                .wrapping_sub(COLS as size_t)
                .wrapping_add(statelen),
            (COLS as size_t).wrapping_sub(statelen),
            0 as libc::c_int != 0,
            0 as libc::c_int != 0,
        );
        waddnstr(topwin, caption, -(1 as libc::c_int));
                    ...
                    ) != 0 as libc::c_int as libc::c_uint)
    {
        ...
        if statelen < COLS as size_t {
            wmove(
                topwin,
                0 as libc::c_int,
                ((COLS + 2 as libc::c_int) as size_t).wrapping_sub(statelen)
                    as libc::c_int,
            );
            show_states_at(topwin);
        }
    } else if statelen > 0 as libc::c_int as size_t && statelen <= COLS as size_t {
        if wmove(
            topwin,
            0 as libc::c_int,
            (COLS as size_t).wrapping_sub(statelen) as libc::c_int,
        ) == -(1 as libc::c_int)
        {
            -(1 as libc::c_int);
        } else {
    ...
    } else if statelen > 0 as libc::c_int as size_t {
...
pub unsafe extern "C" fn minibar() {
    ...
    sprintf(
        ...
        (xplustabs()).wrapping_add(1 as libc::c_int as size_t),
    );
    placewidth = strlen(location);
    namewidth = breadth(thename);
    if namewidth.wrapping_add(19 as libc::c_int as size_t) > COLS as size_t {
        padding = 0 as libc::c_int as size_t;
    }
    if COLS > 4 as libc::c_int {
        if namewidth > (COLS - 2 as libc::c_int) as size_t {
    ...
    if report_size as libc::c_int != 0 && COLS > 35 as libc::c_int {
        let mut count: size_t = ((*(*openfile).filebot).lineno
            - (*((*(*openfile).filebot).data).offset(0 as libc::c_int as isize)
                as libc::c_int == '\0' as i32) as libc::c_int as ssize_t) as size_t;
        number_of_lines = nmalloc(49 as libc::c_int as size_t) as *mut libc::c_char;
                ...
                == UNSPECIFIED as libc::c_int as libc::c_uint
        {
            ...
            sprintf(
                ...
                dcngettext(
                    0 as *const libc::c_char,
                    b" (%zu line, %s)\0" as *const u8 as *const libc::c_char,
                    b" (%zu lines, %s)\0" as *const u8 as *const libc::c_char,
                    count,
                    5 as libc::c_int,
                ),
                count,
        ...
        if namewidth.wrapping_add(tallywidth).wrapping_add(11 as libc::c_int as size_t)
            < COLS as size_t
        {
        ...
        if namewidth
            ...
            .wrapping_add(32 as libc::c_int as size_t) < COLS as size_t
        {
            ...
            .wrapping_add(32 as libc::c_int as size_t) < COLS as size_t
    {
        if wmove(
            footwin,
            0 as libc::c_int,
            ((COLS - 27 as libc::c_int) as size_t).wrapping_sub(placewidth)
                as libc::c_int,
        ) == -(1 as libc::c_int)
        {
            -(1 as libc::c_int);
    ...
    if flags[(CONSTANT_SHOW as libc::c_int as libc::c_ulong)
        ...
        && namewidth.wrapping_add(tallywidth).wrapping_add(28 as libc::c_int as size_t)
            < COLS as size_t
    {
    ...
    if flags[(STATEFLAGS as libc::c_int as libc::c_ulong)
        ...
        && namewidth
            .wrapping_add(tallywidth)
            .wrapping_add(14 as libc::c_int as size_t)
            .wrapping_add(2 as libc::c_int as size_t * padding) < COLS as size_t
    {
        wmove(
            footwin,
            0 as libc::c_int,
            ((COLS - 11 as libc::c_int) as size_t).wrapping_sub(padding) as libc::c_int,
        );
        show_states_at(footwin);
    }
    if (*(*openfile).current).has_anchor as libc::c_int != 0
        && namewidth.wrapping_add(7 as libc::c_int as size_t) < COLS as size_t
    {
        if wmove(
            footwin,
            0 as libc::c_int,
            ((COLS - 5 as libc::c_int) as size_t).wrapping_sub(padding) as libc::c_int,
        ) == -(1 as libc::c_int)
        {
            -(1 as libc::c_int);
        } else {
            waddnstr(
                footwin,
                if using_utf8 as libc::c_int != 0 {
                    b"\xE2\x80\xA0\0" as *const u8 as *const libc::c_char
                } else {
                    b"+\0" as *const u8 as *const libc::c_char
                },
                -(1 as libc::c_int),
    ...
    if namewidth.wrapping_add(6 as libc::c_int as size_t) < COLS as size_t {
        sprintf(
            location,
            b"%3zi%%\0" as *const u8 as *const libc::c_char,
            100 as libc::c_int as ssize_t * (*(*openfile).current).lineno
                / (*(*openfile).filebot).lineno,
        );
        if wmove(
            footwin,
            0 as libc::c_int,
            ((COLS - 4 as libc::c_int) as size_t).wrapping_sub(padding) as libc::c_int,
        ) == -(1 as libc::c_int)
        {
            -(1 as libc::c_int);
        } else {
    ...
    wrefresh(footwin);
    free(number_of_lines as *mut libc::c_void);
    free(hexadecimal as *mut libc::c_void);
    free(location as *mut libc::c_void);
    free(thename as *mut libc::c_void);
    free(ranking as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn statusline(
    ...
    if importance as libc::c_uint >= AHEM as libc::c_int as libc::c_uint {
        waiting_codes = 0 as libc::c_int as size_t;
    }
    ...
    if isendwin() {
        ...
        free(compound as *mut libc::c_void);
        return;
    }
    if !we_are_running
    ...
    if lastmessage as libc::c_uint == ALERT as libc::c_int as libc::c_uint {
        if start_col > 4 as libc::c_int as size_t {
            wmove(
                footwin,
                0 as libc::c_int,
                ((COLS + 2 as libc::c_int) as size_t).wrapping_sub(start_col)
                    as libc::c_int,
            );
            wattr_on(
                footwin,
    ...
    start_col = (COLS as size_t).wrapping_sub(breadth(message))
        / 2 as libc::c_int as size_t;
    bracketed = start_col > 1 as libc::c_int as size_t;
    wmove(
        footwin,
        0 as libc::c_int,
        (if bracketed as libc::c_int != 0 {
            start_col.wrapping_sub(2 as libc::c_int as size_t)
        } else {
            start_col
        }) as libc::c_int,
    );
    ...
    countdown = if flags[(QUICK_BLANK as libc::c_int as libc::c_ulong)
        .wrapping_div(
            (::core::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                .wrapping_mul(8 as libc::c_int as libc::c_ulong),
        ) as usize]
...
pub unsafe extern "C" fn post_one_key(
    ...
    width = (width as size_t).wrapping_sub(breadth(keystroke)) as libc::c_int
        as libc::c_int;
...
pub unsafe extern "C" fn bottombars(mut menu: libc::c_int) {
    ...
    itemwidth = COLS as size_t
        / (number.wrapping_add(1 as libc::c_int as size_t) / 2 as libc::c_int as size_t);
    if itemwidth == 0 as libc::c_int as size_t {
        return;
    }
    blank_bottombars();
    f = allfuncs;
            ...
            if !s.is_null() {
                wmove(
                    ...
                    (1 as libc::c_int as size_t)
                        .wrapping_add(index % 2 as libc::c_int as size_t) as libc::c_int,
                    (index / 2 as libc::c_int as size_t * itemwidth) as libc::c_int,
                );
                if number % 2 as libc::c_int as size_t == 1 as libc::c_int as size_t
                    && index.wrapping_add(2 as libc::c_int as size_t) == number
                {
                    thiswidth = thiswidth.wrapping_add(itemwidth);
                }
                if index.wrapping_add(2 as libc::c_int as size_t) >= number {
                    thiswidth = thiswidth.wrapping_add(COLS as size_t % itemwidth);
                }
                post_one_key(
                    (*s).keystr,
...
pub unsafe extern "C" fn place_the_cursor() {
                ...
                ) != 0 as libc::c_int as libc::c_uint
    {
        ...
        while !line.is_null() && line != (*openfile).current {
            row = (row as size_t)
                .wrapping_add(
                    (1 as libc::c_int as size_t).wrapping_add(extra_chunks_in(line)),
                ) as ssize_t as ssize_t;
            line = (*line).next;
        }
        row = (row as size_t)
            ...
            as ssize_t as ssize_t;
        column = column.wrapping_sub(leftedge);
    } else {
        row = (*(*openfile).current).lineno - (*(*openfile).edittop).lineno;
        column = column.wrapping_sub(get_page_start(column));
    }
    if row < editwinrows as ssize_t {
        wmove(
            midwin,
            row as libc::c_int,
            (margin as size_t).wrapping_add(column) as libc::c_int,
        );
    } else {
        statusline(
            ALERT,
...
pub unsafe extern "C" fn draw_row(
    ...
    if margin > 0 as libc::c_int {
        ...
        if flags[(SOFTWRAP as libc::c_int as libc::c_ulong)
            ...
            && from_col != 0 as libc::c_int as size_t
        {
            mvwprintw(
                midwin,
                row,
                    ...
                    ) != 0 as libc::c_int as libc::c_uint)
    {
        ...
        if (*(*openfile).syntax).multiscore as libc::c_int > 0 as libc::c_int
            && ((*line).multidata).is_null()
        {
            (*line)
                .multidata = nmalloc(
                ((*(*openfile).syntax).multiscore as libc::c_ulong)
                    .wrapping_mul(
        ...
        while !varnish.is_null() {
            ...
            if ((*varnish).end).is_null() {
                while index < 2000 as libc::c_int as size_t && index < till_x {
                    if regexec(
                        (*varnish).start,
                    ...
                    match_0
                        .rm_so = (match_0.rm_so as size_t).wrapping_add(index)
                        as regoff_t as regoff_t;
                    match_0
                        .rm_eo = (match_0.rm_eo as size_t).wrapping_add(index)
                        as regoff_t as regoff_t;
                    index = match_0.rm_eo as size_t;
                    if match_0.rm_so as size_t >= till_x {
                        break;
                    }
                    if match_0.rm_so == match_0.rm_eo {
                        ...
                        if match_0.rm_eo as size_t <= from_x {
                            continue;
                        }
                        if match_0.rm_so as size_t > from_x {
                        ...
                        paintlen = actual_x(
                            ...
                            (wideness((*line).data, match_0.rm_eo as size_t))
                                ...
                                .wrapping_sub(start_col as size_t),
                        ) as libc::c_int;
                        wattr_on(
                            midwin,
                ...
                *((*line).multidata)
                ...
                if !start_line.is_null() && ((*start_line).multidata).is_null() {
                    ...
                    current_block_63 = 11626999923138678822;
                            ...
                            as libc::c_int == (1 as libc::c_int) << 2 as libc::c_int)
                {
                    ...
                    ) == _REG_NOMATCH as libc::c_int
                    {
                        ...
                        *((*line).multidata)
                            ...
                            as libc::c_short;
                        current_block_63 = 8236137900636309791;
                    } else {
                        if endmatch.rm_eo as size_t > from_x {
                            paintlen = actual_x(
                                converted,
                ...
                match current_block_63 {
                    ...
                    _ => {
                        ...
                        while index < 2000 as libc::c_int as size_t
                            && regexec(
                                (*varnish).start,
                        ...
                        {
                            startmatch
                                .rm_so = (startmatch.rm_so as size_t).wrapping_add(index)
                                as regoff_t as regoff_t;
                            startmatch
                                .rm_eo = (startmatch.rm_eo as size_t).wrapping_add(index)
                                as regoff_t as regoff_t;
                            if startmatch.rm_so as size_t > from_x {
                                start_col = (wideness(
                                    (*line).data,
    ...
    if stripe_column as size_t > from_col && !inhelp
        && (sequel_column == 0 as libc::c_int as size_t
            || stripe_column as size_t <= sequel_column)
        && stripe_column as size_t <= from_col.wrapping_add(editwincols as size_t)
    {
        let mut target_column: ssize_t = (stripe_column as size_t)
            .wrapping_sub(from_col)
        ...
        if wmove(midwin, row, (margin as ssize_t + target_column) as libc::c_int)
            == -(1 as libc::c_int)
        {
            -(1 as libc::c_int);
        } else {
                ...
                && (*line).lineno >= (*(*openfile).current).lineno)
    {
        ...
        if top_x < till_x && bot_x > from_x {
            ...
            if bot_x < till_x {
                ...
                paintlen_0 = actual_x(
                    thetext_0,
                    end_col.wrapping_sub(start_col_0 as size_t),
                ) as libc::c_int;
            }
            wattr_on(
                midwin,
...
pub unsafe extern "C" fn update_line(
    ...
    if from_col > 0 as libc::c_int as size_t {
    ...
    if has_more {
        wattr_on(midwin, hilite_attribute as attr_t, 0 as *mut libc::c_void);
        if wmove(midwin, row, COLS - 1 as libc::c_int - sidebar) == -(1 as libc::c_int) {
            -(1 as libc::c_int);
        } else {
            waddch(midwin, '>' as i32 as chtype);
        };
...
pub unsafe extern "C" fn update_softwrapped_line(
    ...
    while someline != line && !someline.is_null() {
        row = (row as size_t)
            .wrapping_add(
                (1 as libc::c_int as size_t).wrapping_add(extra_chunks_in(someline)),
            ) as libc::c_int as libc::c_int;
                ...
                ) != 0 as libc::c_int as libc::c_uint
    {
        ...
        while i > 0 as libc::c_int {
            ...
            *leftedge = 0 as libc::c_int as size_t;
            if chunk >= i as size_t {
                return go_forward_chunks(
                    chunk.wrapping_sub(i as size_t) as libc::c_int,
                    line,
                    leftedge,
                );
            }
            ...
            i = (i as size_t).wrapping_sub(chunk) as libc::c_int as libc::c_int;
            *line = (**line).prev;
...
pub unsafe extern "C" fn less_than_a_screenful(
                ...
                ) != 0 as libc::c_int as libc::c_uint
    {
        ...
        return rows_left > 0 as libc::c_int || ((*line).lineno as size_t) < was_lineno
            || (*line).lineno as size_t == was_lineno && leftedge <= was_leftedge;
    } else {
        return ((*(*openfile).current).lineno as size_t).wrapping_sub(was_lineno)
            < editwinrows as size_t
    };
}
#[no_mangle]
pub unsafe extern "C" fn draw_scrollbar() {
    let mut fromline: libc::c_int = ((*(*openfile).edittop).lineno
        - 1 as libc::c_int as ssize_t) as libc::c_int;
                ...
                ) != 0 as libc::c_int as libc::c_uint
    {
        ...
        while ((*line).lineno + extras as ssize_t) < (fromline + editwinrows) as ssize_t
            && !((*line).next).is_null()
        {
            line = (*line).next;
            extras = (extras as size_t).wrapping_add(extra_chunks_in(line))
                as libc::c_int as libc::c_int;
        }
        coveredlines = ((*line).lineno - fromline as ssize_t) as libc::c_int;
    }
...
pub unsafe extern "C" fn edit_scroll(mut direction: bool) {
    ...
    {
        nrows = (nrows as size_t).wrapping_add(chunk_for(leftedge, line)) as libc::c_int
            as libc::c_int;
        if line == (*openfile).edittop {
            nrows = (nrows as size_t)
                .wrapping_sub(chunk_for((*openfile).firstcolumn, line)) as libc::c_int
                as libc::c_int;
        }
    }
...
pub unsafe extern "C" fn get_softwrap_breakpoint(
    ...
    let mut rightside: size_t = leftedge.wrapping_add(editwincols as size_t);
    let mut breaking_col: size_t = rightside;
    ...
    while *text as libc::c_int != '\0' as i32 && column <= rightside {
        if flags[(AT_BLANKS as libc::c_int as libc::c_ulong)
            ...
            && is_blank_char(text) as libc::c_int != 0 && column < rightside
        {
            farthest_blank = text;
    ...
    if !farthest_blank.is_null() {
        let mut aftertheblank: size_t = last_blank_col;
        let mut onestep: size_t = advance_over(farthest_blank, &mut aftertheblank)
            as size_t;
        if aftertheblank <= rightside {
            text = farthest_blank.offset(onestep as isize);
    ...
    return if editwincols > 1 as libc::c_int {
        ...
        column.wrapping_sub(1 as libc::c_int as size_t)
    };
}
#[no_mangle]
...
pub unsafe extern "C" fn current_is_below_screen() -> bool {
                ...
                ) != 0 as libc::c_int as libc::c_uint
    {
        ...
        return (*(*openfile).current).lineno
            >= (*(*openfile).edittop).lineno + editwinrows as ssize_t
                - (if flags[(ZERO as libc::c_int as libc::c_ulong)
                    .wrapping_div(
                        (::core::mem::size_of::<libc::c_uint>() as libc::c_ulong)
                            .wrapping_mul(8 as libc::c_int as libc::c_ulong),
...
pub unsafe extern "C" fn edit_redraw(
    ...
    if !((*openfile).mark).is_null() {
        ...
        && get_page_start(was_pww) > 0 as libc::c_int as size_t
    {
    ...
    if line_needs_update(was_pww, (*openfile).placewewant) as libc::c_int != 0
        || old_current != (*openfile).current
            && get_page_start((*openfile).placewewant) > 0 as libc::c_int as size_t
    {
        update_line((*openfile).current, (*openfile).current_x);
    }
}
...
pub unsafe extern "C" fn adjust_viewport(mut manner: update_type) {
    ...
    if manner as libc::c_uint == STATIONARY as libc::c_int as libc::c_uint {
        goal = (*openfile).cursor_row as libc::c_int;
...
pub unsafe extern "C" fn report_cursor_position() {
    let mut fullwidth: size_t = (breadth((*(*openfile).current).data))
        .wrapping_add(1 as libc::c_int as size_t);
    let mut column: size_t = (xplustabs()).wrapping_add(1 as libc::c_int as size_t);
    ...
    *((*(*openfile).current).data).offset((*openfile).current_x as isize) = saved_byte;
    linepct = (100 as libc::c_int as ssize_t * (*(*openfile).current).lineno
        / (*(*openfile).filebot).lineno) as libc::c_int;
    colpct = (100 as libc::c_int as size_t * column / fullwidth) as libc::c_int;
    charpct = (if (*openfile).totsize == 0 as libc::c_int as size_t {
        0 as libc::c_int as size_t
    } else {
        100 as libc::c_int as size_t * sum / (*openfile).totsize
    }) as libc::c_int;
    statusline(
        INFO,
        dcgettext(
...
pub unsafe extern "C" fn spotlight(mut from_col: size_t, mut to_col: size_t) {
    let mut right_edge: size_t = (get_page_start(from_col))
        .wrapping_add(editwincols as size_t);
    ...
    if overshoots {
        if wmove(
            midwin,
            (*openfile).cursor_row as libc::c_int,
            COLS - 1 as libc::c_int - sidebar,
        ) == -(1 as libc::c_int)
        {
            -(1 as libc::c_int);
        } else {
...
pub unsafe extern "C" fn spotlight_softwrapped(
    ...
    while row < editwinrows as ssize_t {
...
pub unsafe extern "C" fn do_credits() {
    ...
    let mut credits: [*const libc::c_char; 52] = [
        0 as *const libc::c_char,
        0 as *const libc::c_char,
        b"8.6\0" as *const u8 as *const libc::c_char,
        b"\0" as *const u8 as *const libc::c_char,
        0 as *const libc::c_char,
        ...
        b"\0" as *const u8 as *const libc::c_char,
        b"\0" as *const u8 as *const libc::c_char,
        b"(C) 2025\0" as *const u8 as *const libc::c_char,
    ...
    while crpos < 52 as libc::c_int + editwinrows / 2 as libc::c_int {
        if crpos < 52 as libc::c_int {
            ...
            if wmove(
                midwin,
                editwinrows - 1 as libc::c_int,
                ((COLS as size_t).wrapping_sub(breadth(text))
                    / 2 as libc::c_int as size_t) as libc::c_int,
            ) == -(1 as libc::c_int)
            {
                -(1 as libc::c_int);
