...
pub unsafe extern "C" fn mbtowide(
        ...
        && using_utf8 as libc::c_int != 0
    {
        let mut v1: libc::c_uchar = *c.offset(0 as libc::c_int as isize)
            as libc::c_uchar;
        let mut v2: libc::c_uchar = (*c.offset(1 as libc::c_int as isize) as libc::c_int
        ...
        let mut v3: libc::c_uchar = (*c.offset(2 as libc::c_int as isize) as libc::c_int
            ^ 0x80 as libc::c_int) as libc::c_uchar;
        ...
        let mut v4: libc::c_uchar = (*c.offset(3 as libc::c_int as isize) as libc::c_int
            ^ 0x80 as libc::c_int) as libc::c_uchar;
...
pub unsafe extern "C" fn is_doublewidth(mut ch: *const libc::c_char) -> bool {
    let mut wc: wchar_t = 0;
    if (*ch as libc::c_uchar as libc::c_int) < 0xe1 as libc::c_int || !using_utf8 {
        return 0 as libc::c_int != 0;
    }
...
pub unsafe extern "C" fn is_zerowidth(mut ch: *const libc::c_char) -> bool {
    let mut wc: wchar_t = 0;
    if (*ch as libc::c_uchar as libc::c_int) < 0xcc as libc::c_int || !using_utf8 {
        return 0 as libc::c_int != 0;
    }
    if mbtowide(&mut wc, ch) < 0 as libc::c_int {
        return 0 as libc::c_int != 0;
...
pub unsafe extern "C" fn advance_over(
                ...
                as libc::c_int) < -(96 as libc::c_int)
        {
            *column = (*column).wrapping_add(2 as libc::c_int as size_t);
            ...
            if charlen < 0 as libc::c_int {
                *column = (*column).wrapping_add(1 as libc::c_int as size_t);
                return 1 as libc::c_int;
            }
    ...
    if (*string as libc::c_uchar as libc::c_int) < 0x20 as libc::c_int {
        if *string as libc::c_int == '\t' as i32 {
            *column = (*column)
                .wrapping_add(
                    (tabsize as size_t).wrapping_sub(*column % tabsize as size_t),
                );
        } else {
            *column = (*column).wrapping_add(2 as libc::c_int as size_t);
        }
...
pub unsafe extern "C" fn step_left(
    ...
    if using_utf8 {
        ...
        if pos < 4 as libc::c_int as size_t {
            ...
            if *ptr as libc::c_schar as libc::c_int > -(65 as libc::c_int) {
                before = pos.wrapping_sub(1 as libc::c_int as size_t);
            } else {
                ptr = ptr.offset(-1);
                if *ptr as libc::c_schar as libc::c_int > -(65 as libc::c_int) {
                    before = pos.wrapping_sub(2 as libc::c_int as size_t);
                } else {
                    ptr = ptr.offset(-1);
                    if *ptr as libc::c_schar as libc::c_int > -(65 as libc::c_int) {
                        before = pos.wrapping_sub(3 as libc::c_int as size_t);
                    } else {
                        ptr = ptr.offset(-1);
                        if *ptr as libc::c_schar as libc::c_int > -(65 as libc::c_int) {
                            before = pos.wrapping_sub(4 as libc::c_int as size_t);
                        } else {
                            before = pos.wrapping_sub(1 as libc::c_int as size_t);
                        }
                    }
        ...
        while before < pos {
            ...
            before = before.wrapping_add(charlen);
        }
        return before.wrapping_sub(charlen);
    } else {
        return if pos == 0 as libc::c_int as size_t {
...
pub unsafe extern "C" fn step_right(
    ...
    return pos.wrapping_add(char_length(buf.offset(pos as isize)) as size_t);
}
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn strip_leading_blanks_from(mut string: *mut libc::c_char) {
