...
pub const MODERN_BINDINGS: C2RustUnnamed_0 = 50;
pub const ZERO: C2RustUnnamed_0 = 49;
pub const MINIBAR: C2RustUnnamed_0 = 48;
pub const USE_MAGIC: C2RustUnnamed_0 = 47;
pub const STATEFLAGS: C2RustUnnamed_0 = 46;
pub const COLON_PARSING: C2RustUnnamed_0 = 45;
...
static mut rcopts: [rcoption; 68] = [
    ...
    },
    {
        let mut init = rcoption {
            ...
            flag: COLON_PARSING as libc::c_int as libc::c_long,
        };
        init
    },
    {
    ...
    },
    {
        let mut init = rcoption {
            ...
            flag: WHITESPACE_DISPLAY as libc::c_int as libc::c_long,
        };
        init
    },
    {
...
pub unsafe extern "C" fn jot_error(mut msg: *const libc::c_char, mut args: ...) {
    ...
    if lineno > 0 as libc::c_int as size_t {
        length = snprintf(
            textbuf.as_mut_ptr(),
            (4096 as libc::c_int + 200 as libc::c_int) as libc::c_ulong,
            dcgettext(
...
pub unsafe extern "C" fn strtosc(mut input: *const libc::c_char) -> *mut keystruct {
    let mut s: *mut keystruct = nmalloc(
        ::core::mem::size_of::<keystruct>() as libc::c_ulong,
    ) as *mut keystruct;
    ...
    } else if strcmp(input, b"toprow\0" as *const u8 as *const libc::c_char) == 0 {
        (*s).func = Some(to_top_row as unsafe extern "C" fn() -> ());
    } else if strcmp(input, b"bottomrow\0" as *const u8 as *const libc::c_char) == 0 {
        (*s).func = Some(to_bottom_row as unsafe extern "C" fn() -> ());
    } else if strcmp(input, b"center\0" as *const u8 as *const libc::c_char) == 0 {
        (*s).func = Some(do_center as unsafe extern "C" fn() -> ());
    } else if strcmp(input, b"cycle\0" as *const u8 as *const libc::c_char) == 0 {
        (*s).func = Some(do_cycle as unsafe extern "C" fn() -> ());
...
pub unsafe extern "C" fn compile(
    ...
    let mut outcome: libc::c_int = regcomp(compiled, expression, rex_flags);
    if outcome != 0 as libc::c_int {
        let mut length: size_t = regerror(
            outcome,
            compiled,
        ...
        regfree(compiled);
        free(compiled as *mut libc::c_void);
    } else {
        *packed = compiled;
    }
...
pub unsafe extern "C" fn begin_new_syntax(mut ptr: *mut libc::c_char) {
    ...
    live_syntax = nmalloc(::core::mem::size_of::<syntaxtype>() as libc::c_ulong)
        as *mut syntaxtype;
...
pub unsafe extern "C" fn parse_binding(mut ptr: *mut libc::c_char, mut dobind: bool) {
    ...
    if *keycopy.offset(0 as libc::c_int as isize) as libc::c_int == '^' as i32 {
        if 'a' as i32 <= *keycopy.offset(1 as libc::c_int as isize) as libc::c_int
            && *keycopy.offset(1 as libc::c_int as isize) as libc::c_int <= 'z' as i32
        {
            let ref mut fresh2 = *keycopy.offset(1 as libc::c_int as isize);
            *fresh2 = (*fresh2 as libc::c_int & 0x5f as libc::c_int) as libc::c_char;
        }
    } else if 'a' as i32 <= *keycopy.offset(0 as libc::c_int as isize) as libc::c_int
        && *keycopy.offset(0 as libc::c_int as isize) as libc::c_int <= 'z' as i32
    {
        let ref mut fresh3 = *keycopy.offset(0 as libc::c_int as isize);
        *fresh3 = (*fresh3 as libc::c_int & 0x5f as libc::c_int) as libc::c_char;
    }
        ...
        if keycode < 0 as libc::c_int {
            ...
            if dobind {
                    ...
                    == '\0' as i32
                {
                    ...
                    current_block = 18010113479216705612;
                } else if ptr.is_null() {
                    current_block = 18010113479216705612;
                } else {
    ...
    free(keycopy as *mut libc::c_void);
    free(newsc as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn is_good_file(mut file: *mut libc::c_char) -> bool {
    ...
    if stat(file, &mut rcinfo) != -(1 as libc::c_int)
        && (rcinfo.st_mode & 0o170000 as libc::c_int as __mode_t
            == 0o40000 as libc::c_int as __mode_t
            || rcinfo.st_mode & 0o170000 as libc::c_int as __mode_t
                == 0o20000 as libc::c_int as __mode_t
            || rcinfo.st_mode & 0o170000 as libc::c_int as __mode_t
                == 0o60000 as libc::c_int as __mode_t)
    {
        jot_error(
            if rcinfo.st_mode & 0o170000 as libc::c_int as __mode_t
                == 0o40000 as libc::c_int as __mode_t
            {
...
pub unsafe extern "C" fn parse_one_include(
    ...
    free((*syntax).filename as *mut libc::c_void);
...
pub unsafe extern "C" fn parse_includes(mut ptr: *mut libc::c_char) {
    ...
    ptr = parse_argument(ptr);
    if strlen(pattern) > 4096 as libc::c_int as libc::c_ulong {
        jot_error(b"Path is too long\0" as *const u8 as *const libc::c_char);
        return;
    }
...
pub unsafe extern "C" fn closest_index_color(
    ...
    static mut gray: [libc::c_short; 14] = [
        1 as libc::c_int as libc::c_short,
        2 as libc::c_int as libc::c_short,
        3 as libc::c_int as libc::c_short,
        4 as libc::c_int as libc::c_short,
    ...
    } else if red as libc::c_int == green as libc::c_int
        && green as libc::c_int == blue as libc::c_int
        && (0 as libc::c_int) < red as libc::c_int
        && (red as libc::c_int) < 0xf as libc::c_int
    {
        return (232 as libc::c_int
            + gray[(red as libc::c_int - 1 as libc::c_int) as usize] as libc::c_int)
            as libc::c_short
    } else {
...
pub static mut hues: [[libc::c_char; 8]; 34] = unsafe {
    [
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"red\0\0\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"green\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"blue\0\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"yellow\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"cyan\0\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"magenta\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"white\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"black\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"normal\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"pink\0\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"purple\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"mauve\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"lagoon\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"mint\0\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"lime\0\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"peach\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"orange\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"latte\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"rosy\0\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"beet\0\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"plum\0\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"sea\0\0\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"sky\0\0\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"slate\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"teal\0\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"sage\0\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"brown\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"ocher\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"sand\0\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"tawny\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"brick\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"crimson\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"grey\0\0\0\0"),
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"gray\0\0\0\0"),
    ]
};
#[no_mangle]
...
pub unsafe extern "C" fn parse_combination(
    ...
    *attributes = (1 as libc::c_uint).wrapping_sub(1 as libc::c_uint) as libc::c_int;
    ...
    {
        *attributes = (*attributes as chtype
            | (1 as libc::c_uint) << 13 as libc::c_int + 8 as libc::c_int)
            as libc::c_int;
        if *combotext.offset(4 as libc::c_int as isize) as libc::c_int != ',' as i32 {
            jot_error(
        ...
        combotext = combotext.offset(5 as libc::c_int as isize);
    }
    if strncmp(
        combotext,
    ...
    ) == 0 as libc::c_int
    {
        *attributes = (*attributes as chtype
            ...
            as libc::c_int;
        if *combotext.offset(6 as libc::c_int as isize) as libc::c_int != ',' as i32 {
            jot_error(
                b"An attribute requires a subsequent comma\0" as *const u8
                    as *const libc::c_char,
            );
        ...
        combotext = combotext.offset(7 as libc::c_int as isize);
    }
    comma = strchr(combotext, ',' as i32);
    if !comma.is_null() {
        *comma = '\0' as i32 as libc::c_char;
    }
    if comma.is_null() || comma > combotext {
        *fg = color_to_short(combotext, &mut vivid, &mut thick);
    ...
    while *ptr as libc::c_int != '\0' as i32 {
        ...
        if expectend {
            ...
            ) != 0 as libc::c_int
            {
                ...
                regfree(start_rgx);
                free(start_rgx as *mut libc::c_void);
                return;
            }
        ...
        newcolor = nmalloc(::core::mem::size_of::<colortype>() as libc::c_ulong)
            as *mut colortype;
...
#[no_mangle]
pub unsafe extern "C" fn set_interface_color(
    mut element: libc::c_int,
    mut combotext: *mut libc::c_char,
) {
    let mut trio: *mut colortype = nmalloc(
        ::core::mem::size_of::<colortype>() as libc::c_ulong,
    ) as *mut colortype;
    if parse_combination(
        ...
        free(color_combo[element as usize] as *mut libc::c_void);
        color_combo[element as usize] = trio;
    } else {
        free(trio as *mut libc::c_void);
    };
}
#[no_mangle]
pub unsafe extern "C" fn grab_and_store(
    ...
    while *ptr as libc::c_int != '\0' as i32 {
        ...
        newthing = nmalloc(::core::mem::size_of::<regexlisttype>() as libc::c_ulong)
...
pub unsafe extern "C" fn parse_rcfile(
    ...
    loop {
        ...
        if !(length > 0 as libc::c_int as ssize_t) {
            break;
        }
        ...
        if *buffer.offset((length - 1 as libc::c_int as ssize_t) as isize) as libc::c_int
            == '\n' as i32
        {
            length -= 1;
        ...
        if length > 0 as libc::c_int as ssize_t
            && *buffer.offset((length - 1 as libc::c_int as ssize_t) as isize)
                ...
                == 0 as libc::c_int
        {
            ...
            if sntx.is_null() {
                        ...
                        == 0 as libc::c_int
                {
                    ...
                    newitem = nmalloc(
                        ::core::mem::size_of::<augmentstruct>() as libc::c_ulong,
        ...
        if *ptr as libc::c_int == '\0' as i32 {
            ...
            if (rcopts[i as usize].name).is_null() {
                ...
                {
                    set_interface_color(TITLE_BAR as libc::c_int, argument);
                } else if strcmp(
                    option,
                    b"numbercolor\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                {
                    set_interface_color(LINE_NUMBER as libc::c_int, argument);
                } else if strcmp(
                    option,
                    b"stripecolor\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                {
                    set_interface_color(GUIDE_STRIPE as libc::c_int, argument);
                } else if strcmp(
                    option,
                    b"scrollercolor\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                {
                    set_interface_color(SCROLL_BAR as libc::c_int, argument);
                } else if strcmp(
                    option,
                    b"selectedcolor\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                {
                    set_interface_color(SELECTED_TEXT as libc::c_int, argument);
                } else if strcmp(
                    option,
                    b"spotlightcolor\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                {
                    set_interface_color(SPOTLIGHTED as libc::c_int, argument);
                } else if strcmp(
                    option,
                    b"minicolor\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                {
                    set_interface_color(MINI_INFOBAR as libc::c_int, argument);
                } else if strcmp(
                    option,
                    b"promptcolor\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                {
                    set_interface_color(PROMPT_BAR as libc::c_int, argument);
                } else if strcmp(
                    option,
                    b"statuscolor\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                {
                    set_interface_color(STATUS_BAR as libc::c_int, argument);
                } else if strcmp(
                    option,
                    b"errorcolor\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                {
                    set_interface_color(ERROR_MESSAGE as libc::c_int, argument);
                } else if strcmp(
                    option,
                    b"keycolor\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                {
                    set_interface_color(KEY_COMBO as libc::c_int, argument);
                } else if strcmp(
                    option,
                    b"functioncolor\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                {
                    set_interface_color(FUNCTION_TAG as libc::c_int, argument);
                } else if strcmp(
                    option,
                ...
                ) == 0 as libc::c_int
                {
                    ...
                    } else if mbstrlen(argument) % 2 as libc::c_int as size_t
                        != 0 as libc::c_int as size_t
                    {
                        jot_error(
                ...
                {
                    if mbstrlen(argument) != 2 as libc::c_int as size_t
                        || breadth(argument) != 2 as libc::c_int as size_t
                    {
                        jot_error(
...
pub unsafe extern "C" fn have_nanorc(
    ...
    free(nanorc as *mut libc::c_void);
