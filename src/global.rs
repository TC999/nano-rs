...
#[no_mangle]
pub static mut resized_for_browser: sig_atomic_t = 0 as libc::c_int;
#[no_mangle]
pub static mut on_a_vt: bool = 0 as libc::c_int != 0;
#[no_mangle]
pub static mut using_utf8: bool = 0 as libc::c_int != 0;
#[no_mangle]
...
#[no_mangle]
pub static mut foretext: *mut libc::c_char = 0 as *const libc::c_char
    as *mut libc::c_char;
#[no_mangle]
pub static mut final_status: libc::c_int = 0 as libc::c_int;
#[no_mangle]
...
#[no_mangle]
pub static mut althome: libc::c_int = 0;
#[no_mangle]
pub static mut altend: libc::c_int = 0;
#[no_mangle]
...
#[no_mangle]
pub static mut mousefocusin: libc::c_int = 0;
#[no_mangle]
pub static mut mousefocusout: libc::c_int = 0;
#[no_mangle]
...
#[no_mangle]
pub static mut sidebar: libc::c_int = 0 as libc::c_int;
#[no_mangle]
...
#[no_mangle]
pub static mut cycling_aim: libc::c_int = 0 as libc::c_int;
#[no_mangle]
...
pub static mut quotestr: *mut libc::c_char = 0 as *const libc::c_char
    as *mut libc::c_char;
#[no_mangle]
pub static mut quotereg: regex_t = re_pattern_buffer {
...
#[no_mangle]
pub static mut search_regexp: regex_t = re_pattern_buffer {
    buffer: 0 as *const re_dfa_t as *mut re_dfa_t,
    allocated: 0,
    used: 0,
    syntax: 0,
...
pub unsafe extern "C" fn add_to_funcs(
    ...
    let mut f: *mut funcstruct = nmalloc(
        ::core::mem::size_of::<funcstruct>() as libc::c_ulong,
    ) as *mut funcstruct;
    if allfuncs.is_null() {
        allfuncs = f;
    } else {
...
pub unsafe extern "C" fn keycode_from_string(
    ...
    if *keystring.offset(0 as libc::c_int as isize) as libc::c_int == '^' as i32 {
        ...
        {
            if 'A' as i32 <= *keystring.offset(2 as libc::c_int as isize) as libc::c_int
                && *keystring.offset(2 as libc::c_int as isize) as libc::c_int
                    <= 'Z' as i32
            {
                return *keystring.offset(2 as libc::c_int as isize) as libc::c_int
                    | 0x20 as libc::c_int
            } else {
                return *keystring.offset(2 as libc::c_int as isize) as libc::c_int
            }
...
#[no_mangle]
pub unsafe extern "C" fn show_curses_version() {
    statusline(
        NOTICE,
        b"ncurses-%i.%i, patch %li\0" as *const u8 as *const libc::c_char,
        6 as libc::c_int,
        4 as libc::c_int,
        20240113 as libc::c_int,
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn interpret(keycode: libc::c_int) -> functionptrtype {
    if !meta_key && keycode < 0x7f as libc::c_int {
        if keycode == 'N' as i32 {
...
pub unsafe extern "C" fn shortcut_init() {
    ...
    let mut paraend_gist: *const libc::c_char = b"Go just beyond end of paragraph; then of next paragraph\0"
        as *const u8 as *const libc::c_char;
    let mut toprow_gist: *const libc::c_char = b"Go to first row in the viewport\0"
        as *const u8 as *const libc::c_char;
    let mut bottomrow_gist: *const libc::c_char = b"Go to last row in the viewport\0"
        as *const u8 as *const libc::c_char;
    let mut center_gist: *const libc::c_char = b"Center the line where the cursor is\0"
        as *const u8 as *const libc::c_char;
    let mut cycle_gist: *const libc::c_char = b"Push the cursor line to the center, then top, then bottom\0"
        as *const u8 as *const libc::c_char;
    ...
    let mut pipe_gist: *const libc::c_char = b"Pipe the current buffer (or marked region) to the command\0"
        as *const u8 as *const libc::c_char;
    let mut older_command_gist: *const libc::c_char = b"Recall the previous command\0"
        as *const u8 as *const libc::c_char;
    let mut newer_command_gist: *const libc::c_char = b"Recall the next command\0"
        as *const u8 as *const libc::c_char;
    ...
    let mut formatter_gist: *const libc::c_char = b"Invoke a program to format/arrange/manipulate the buffer\0"
        as *const u8 as *const libc::c_char;
    let mut bsp_string: *mut libc::c_char = tgetstr(
        b"kb\0" as *const u8 as *const libc::c_char,
        0 as *mut *mut libc::c_char,
    );
    let mut help_key: *mut libc::c_char = (if !bsp_string.is_null()
        && *bsp_string as libc::c_int != 0x8 as libc::c_int
    {
    ...
    add_to_funcs(
        Some(to_top_row as unsafe extern "C" fn() -> ()),
        (1 as libc::c_int) << 0 as libc::c_int,
    ...
    add_to_funcs(
        Some(to_bottom_row as unsafe extern "C" fn() -> ()),
        (1 as libc::c_int) << 0 as libc::c_int,
    ...
    add_to_funcs(
        Some(do_cycle as unsafe extern "C" fn() -> ()),
        (1 as libc::c_int) << 0 as libc::c_int,
    ...
    add_to_sclist(
        (1 as libc::c_int) << 0 as libc::c_int,
        b"M-Home\0" as *const u8 as *const libc::c_char,
        0x425 as libc::c_int,
        Some(to_top_row as unsafe extern "C" fn() -> ()),
        0 as libc::c_int,
    );
    add_to_sclist(
        (1 as libc::c_int) << 0 as libc::c_int,
        b"M-End\0" as *const u8 as *const libc::c_char,
        0x426 as libc::c_int,
        Some(to_bottom_row as unsafe extern "C" fn() -> ()),
        0 as libc::c_int,
    );
    ...
    add_to_sclist(
        ...
        b"M-&\0" as *const u8 as *const libc::c_char,
        0 as libc::c_int,
        Some(show_curses_version as unsafe extern "C" fn() -> ()),
        0 as libc::c_int,
    );
    add_to_sclist(
        ((1 as libc::c_int) << 0 as libc::c_int | (1 as libc::c_int) << 1 as libc::c_int
    ...
    add_to_sclist(
        ...
        b"\0" as *const u8 as *const libc::c_char,
        0x4b5 as libc::c_int,
        Some(suck_up_input_and_paste_it as unsafe extern "C" fn() -> ()),
        0 as libc::c_int,
    );
    add_to_sclist(
        (1 as libc::c_int) << 0 as libc::c_int | (1 as libc::c_int) << 1 as libc::c_int
...
pub unsafe extern "C" fn epithet_of_flag(mut flag: libc::c_int) -> *const libc::c_char {
    match flag {
        49 => return b"Hidden interface\0" as *const u8 as *const libc::c_char,
