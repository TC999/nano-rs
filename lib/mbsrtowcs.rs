    ...
    if !dest.is_null() {
        ...
        loop {
            if !(len > 0 as libc::c_int as size_t) {
                current_block_35 = 26972500619410423;
                break;
            }
            ...
            if ret == -(1 as libc::c_int) as size_t {
                current_block_35 = 507186232021024084;
                break;
            }
            if ret == 0 as libc::c_int as size_t {
                ...
                if !(0 as libc::c_int != 0 && ret == -(3 as libc::c_int) as size_t) {
        ...
        loop {
            ...
            if ret_0 == -(1 as libc::c_int) as size_t {
                current_block_35 = 14243147024734125626;
                break;
            }
            if ret_0 == 0 as libc::c_int as size_t {
