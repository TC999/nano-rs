...
static mut nonspacing_table_data: [libc::c_uchar; 3136] = [
...
pub unsafe extern "C" fn uc_width(
            ...
            .wrapping_div(::core::mem::size_of::<libc::c_schar>() as libc::c_ulong)
    {
        ...
        if ind >= 0 as libc::c_int {
            if nonspacing_table_data[((64 as libc::c_int * ind) as ucs4_t)
                .wrapping_add(uc >> 3 as libc::c_int & 63 as libc::c_int as ucs4_t)
                as usize] as libc::c_int >> (uc & 7 as libc::c_int as ucs4_t)
                & 1 as libc::c_int != 0
            {
                if uc > 0 as libc::c_int as ucs4_t && uc < 0xa0 as libc::c_int as ucs4_t
                {
                    return -(1 as libc::c_int)
                } else {
                    return 0 as libc::c_int
        ...
        == (0xe0000 as libc::c_int >> 9 as libc::c_int) as ucs4_t
    {
        if uc >= 0xe0100 as libc::c_int as ucs4_t {
            if uc <= 0xe01ef as libc::c_int as ucs4_t {
                return 0 as libc::c_int;
            }
        } else if if uc >= 0xe0020 as libc::c_int as ucs4_t {
            (uc <= 0xe007f as libc::c_int as ucs4_t) as libc::c_int
        } else {
            (uc == 0xe0001 as libc::c_int as ucs4_t) as libc::c_int
        } != 0
        {
            return 0 as libc::c_int
        }
    ...
    if uc >= 0xa1 as libc::c_int as ucs4_t && uc < 0xff61 as libc::c_int as ucs4_t
        && uc != 0x20a9 as libc::c_int as ucs4_t && is_cjk_encoding(encoding) != 0
    {
        return 2 as libc::c_int;
    }
    return 1 as libc::c_int;
