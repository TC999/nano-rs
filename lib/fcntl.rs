...
pub unsafe extern "C" fn rpl_fcntl(
    ...
    match action {
        ...
        _ => {
            ...
            match action {
                1 => {
                    current_block_7 = 5883015881187059330;
                }
                3 => {
                    current_block_7 = 5883015881187059330;
                }
                1025 => {
                    current_block_7 = 16152771998566204523;
                }
                9 => {
                ...
                1034 => {
                    current_block_7 = 11673767183625914418;
                }
                11 => {
                    current_block_7 = 17306231624930509618;
                }
                1033 => {
