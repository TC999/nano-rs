...
pub unsafe extern "C" fn printf_parse(
    ...
    loop {
        if !(*cp as libc::c_int != '\0' as i32) {
            current_block = 13123766469113069713;
            break;
        }
        let fresh0 = cp;
        cp = cp.offset(1);
        ...
        if *cp as libc::c_int >= '0' as i32 && *cp as libc::c_int <= '9' as i32 {
            ...
            if *np as libc::c_int == '$' as i32 {
                ...
                if n == 0 as libc::c_int as size_t {
                    current_block = 10467436443761725759;
                    break;
                } else if n == 18446744073709551615 as libc::c_ulong {
                    current_block = 10467436443761725759;
                    break;
                } else {
                    arg_index = n.wrapping_sub(1 as libc::c_int as size_t);
        ...
        if *cp as libc::c_int == '*' as i32 {
            ...
            cp;
            (*dp).width_end = cp;
            if max_width_length < 1 as libc::c_int as size_t {
            ...
            if *cp as libc::c_int >= '0' as i32 && *cp as libc::c_int <= '9' as i32 {
                ...
                if *np_0 as libc::c_int == '$' as i32 {
                        ...
                        n_0 = xsum(
                            if n_0
                                <= (18446744073709551615 as libc::c_ulong)
                                    .wrapping_div(10 as libc::c_int as libc::c_ulong)
                            {
                                n_0 * 10 as libc::c_int as size_t
                            } else {
                                18446744073709551615 as libc::c_ulong
                            },
                    ...
                    if n_0 == 0 as libc::c_int as size_t {
                        current_block = 10467436443761725759;
                        break;
            ...
            if n_1 >= a_allocated {
                ...
                {
                    a_allocated * 2 as libc::c_int as size_t
                } else {
                    18446744073709551615 as libc::c_ulong
                };
                if a_allocated <= n_1 {
                ...
                if memory_size == 18446744073709551615 as libc::c_ulong {
                    current_block = 17811556773871731568;
                    break;
                }
                memory = (if (*a).arg != ((*a).direct_alloc_arg).as_mut_ptr() {
                    rpl_realloc((*a).arg as *mut libc::c_void, memory_size)
                } else {
                    malloc(memory_size)
                }) as *mut argument;
                if memory.is_null() {
        ...
        if *cp as libc::c_int == '.' as i32 {
            ...
            if *cp as libc::c_int == '*' as i32 {
                ...
                cp;
                (*dp).precision_end = cp;
                if max_precision_length < 2 as libc::c_int as size_t {
                ...
                if *cp as libc::c_int >= '0' as i32 && *cp as libc::c_int <= '9' as i32 {
                    ...
                    if *np_1 as libc::c_int == '$' as i32 {
                            ...
                            n_2 = xsum(
                                if n_2
                                    <= (18446744073709551615 as libc::c_ulong)
                                        .wrapping_div(10 as libc::c_int as libc::c_ulong)
                                {
                                    n_2 * 10 as libc::c_int as size_t
                                } else {
                                    18446744073709551615 as libc::c_ulong
                                },
                        ...
                        if n_2 == 0 as libc::c_int as size_t {
                            current_block = 10467436443761725759;
                            break;
                ...
                if n_3 >= a_allocated {
                    ...
                    memory_0 = (if (*a).arg != ((*a).direct_alloc_arg).as_mut_ptr() {
                        rpl_realloc((*a).arg as *mut libc::c_void, memory_size_0)
                    } else {
        ...
        if type_0 as libc::c_uint != TYPE_NONE as libc::c_int as libc::c_uint {
            ...
            if n_4 >= a_allocated {
                ...
                memory_1 = (if (*a).arg != ((*a).direct_alloc_arg).as_mut_ptr() {
                    rpl_realloc((*a).arg as *mut libc::c_void, memory_size_1)
                } else {
        ...
        d_allocated = if d_allocated
            <= (18446744073709551615 as libc::c_ulong)
                .wrapping_div(2 as libc::c_int as libc::c_ulong)
        {
            d_allocated * 2 as libc::c_int as size_t
        } else {
            18446744073709551615 as libc::c_ulong
        };
        ...
        if memory_size_2 == 18446744073709551615 as libc::c_ulong {
            ...
            memory_2 = (if (*d).dir != ((*d).direct_alloc_dir).as_mut_ptr() {
                rpl_realloc((*d).dir as *mut libc::c_void, memory_size_2)
            } else {
