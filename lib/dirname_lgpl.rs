...
pub unsafe extern "C" fn dir_len(mut file: *const libc::c_char) -> size_t {
    ...
    prefix_length = prefix_length
        .wrapping_add(
            (if prefix_length != 0 as libc::c_int as size_t {
                (0 as libc::c_int != 0
    ...
    while prefix_length < length {
        if !(*file.offset(length.wrapping_sub(1 as libc::c_int as size_t) as isize)
...
pub unsafe extern "C" fn mdir_name(mut file: *const libc::c_char) -> *mut libc::c_char {
    ...
    let mut append_dot: bool = length == 0 as libc::c_int as size_t
        || 0 as libc::c_int != 0 && length == 0 as libc::c_int as size_t
    ...
    let mut dir: *mut libc::c_char = malloc(
        length
            .wrapping_add(append_dot as size_t)
