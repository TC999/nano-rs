...
pub unsafe extern "C" fn chdir_long(mut dir: *mut libc::c_char) -> libc::c_int {
    ...
    cdb_init(&mut cdb);
    (0 as libc::c_int != 0 && (0 as libc::c_int as size_t) < len) as libc::c_int;
    (0 as libc::c_int != 0 && 4096 as libc::c_int as size_t <= len) as libc::c_int;
    n_leading_slash = strspn(dir, b"/\0" as *const u8 as *const libc::c_char);
    if n_leading_slash == 2 as libc::c_int as size_t {
        ...
        *slash = '/' as i32 as libc::c_char;
        if err != 0 as libc::c_int {
            current_block = 969375630800679106;
        } else {
