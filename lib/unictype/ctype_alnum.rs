...
static mut u_is_alnum: C2RustUnnamed = C2RustUnnamed {
    header: [0; 1],
    level1: [0; 4],
    level2: [0; 512],
    level3: [0; 1360],
...
#[no_mangle]
pub unsafe extern "C" fn uc_is_alnum(mut uc: ucs4_t) -> bool {
    return bitmap_lookup(&u_is_alnum as *const C2RustUnnamed as *const libc::c_void, uc)
        != 0;
}
