...
static mut u_is_graph: C2RustUnnamed = C2RustUnnamed {
    header: [0; 1],
    level1: [0; 17],
    level2: [0; 768],
    level3: [0; 1504],
...
#[no_mangle]
pub unsafe extern "C" fn uc_is_graph(mut uc: ucs4_t) -> bool {
    return bitmap_lookup(&u_is_graph as *const C2RustUnnamed as *const libc::c_void, uc)
        != 0;
}
