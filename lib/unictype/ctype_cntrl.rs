...
static mut u_is_cntrl: C2RustUnnamed = C2RustUnnamed {
    header: [0; 1],
    level1: [0; 1],
    level2: [0; 128],
    level3: [0; 32],
...
#[no_mangle]
pub unsafe extern "C" fn uc_is_cntrl(mut uc: ucs4_t) -> bool {
    return bitmap_lookup(&u_is_cntrl as *const C2RustUnnamed as *const libc::c_void, uc)
        != 0;
}
