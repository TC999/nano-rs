...
pub struct C2RustUnnamed {
    ...
    pub level1: [libc::c_int; 1],
    pub level2: [libc::c_short; 128],
    pub level3: [libc::c_uint; 64],
}
#[inline]
...
static mut u_is_blank: C2RustUnnamed = C2RustUnnamed {
    header: [0; 1],
    level1: [0; 1],
    level2: [0; 128],
    level3: [0; 64],
...
#[no_mangle]
pub unsafe extern "C" fn uc_is_blank(mut uc: ucs4_t) -> bool {
    return bitmap_lookup(&u_is_blank as *const C2RustUnnamed as *const libc::c_void, uc)
        != 0;
}
